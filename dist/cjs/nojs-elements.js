 ...
 * @license MIT
 */
var dt=Object.defineProperty;var We=Object.getOwnPropertyDescriptor;var Ve=Object.getOwnPropertyNames;var Ke=Object.prototype.hasOwnProperty;var Ue=(e,t)=>{for(var r in t)dt(e,r,{get:t[r],enumerable:!0})},Ye=(e,t,r,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of Ve(t))!Ke.call(e,o)&&o!==r&&dt(e,o,{get:()=>t[o],enumerable:!(i=We(t,o))||i.enumerable});return e};var Xe=e=>Ye(dt({},"__esModule",{value:!0}),e);var Cr={};Ue(Cr,{default:()=>Lr});module.exports=Xe(Cr);var Y=new Map,T=new Map;function Et(){for(let e of T.values())clearTimeout(e);T.clear();for(let e of Y.values())e.remove();Y.clear()}function jt(){if(typeof document>"u"||document.querySelector("style[data-nojs-tooltip]"))return;let e=`
.nojs-tooltip {
  position: fixed;
  z-index: 9999;
  pointer-events: none;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tooltip",""),t.textContent=e,document.head.appendChild(t)}function Ne(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var J=8;function Ze(e,t,r){let i=t.getBoundingClientRect(),o=e.getBoundingClientRect(),n=window.innerWidth,d=window.innerHeight,s,l;switch(r){case"bottom":s=i.bottom+J,l=i.left+(i.width-o.width)/2;break;case"left":s=i.top+(i.height-o.height)/2,l=i.left-o.width-J;break;case"right":s=i.top+(i.height-o.height)/2,l=i.right+J;break;default:s=i.top-o.height-J,l=i.left+(i.width-o.width)/2;break}l<4&&(l=4),l+o.width>n-4&&(l=n-o.width-4),s<4&&(s=4),s+o.height>d-4&&(s=d-o.height-4),e.style.top=`${s}px`,e.style.left=`${l}px`}var Qe=0;function Je(e,t,r){document.body.appendChild(t),Ze(t,e,r),t.setAttribute("aria-hidden","false")}function tr(e,t){t.setAttribute("aria-hidden","true"),t.remove()}function kt(e){e.directive("tooltip",{priority:20,init(t,r,i){jt();let o=i;if(!o){console.warn("[tooltip] attribute value (tooltip text) is required.");return}let n=t.getAttribute("tooltip-position")||"top",d=parseInt(t.getAttribute("tooltip-delay"),10)||300,s=t.getAttribute("tooltip-disabled"),l=s?e.findContext(t):null,f=`nojs-tooltip-${++Qe}`,p=document.createElement("div");p.className="nojs-tooltip",p.setAttribute("role","tooltip"),p.setAttribute("id",f),p.setAttribute("aria-hidden","true"),p.textContent=o,t.setAttribute("aria-describedby",f),Y.set(t,p);let m=()=>{if(s&&l&&e.evaluate(s,l))return;T.has(t)&&clearTimeout(T.get(t));let y=setTimeout(()=>{T.delete(t),!(s&&l&&e.evaluate(s,l))&&Je(t,p,n)},d);T.set(t,y)},h=()=>{T.has(t)&&(clearTimeout(T.get(t)),T.delete(t)),tr(t,p)},c=()=>m(),a=()=>h(),u=()=>m(),b=()=>h(),g=y=>{y.key==="Escape"&&p.getAttribute("aria-hidden")==="false"&&h()};t.addEventListener("mouseenter",c),t.addEventListener("mouseleave",a),t.addEventListener("focusin",u),t.addEventListener("focusout",b),t.addEventListener("keydown",g),Ne(t,()=>{t.removeEventListener("mouseenter",c),t.removeEventListener("mouseleave",a),t.removeEventListener("focusin",u),t.removeEventListener("focusout",b),t.removeEventListener("keydown",g),T.has(t)&&(clearTimeout(T.get(t)),T.delete(t)),p.remove(),Y.delete(t)})}})}function _t(e,t={}){kt(e)}function St(){Et()}var S=new Map;function Lt(){S.clear()}function tt(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let e=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-modal",""),t.textContent=e,document.head.appendChild(t)}function rr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var Pt='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',ut=new WeakMap;function or(e){let t=r=>{if(r.key!=="Tab")return;let i=[...e.querySelectorAll(Pt)].filter(d=>d.offsetParent!==null);if(i.length===0){r.preventDefault();return}let o=i[0],n=i[i.length-1];r.shiftKey?document.activeElement===o&&(r.preventDefault(),n.focus()):document.activeElement===n&&(r.preventDefault(),o.focus())};e.addEventListener("keydown",t),ut.set(e,t)}function Ft(e){let t=ut.get(e);t&&(e.removeEventListener("keydown",t),ut.delete(e))}var X=new WeakMap;function Mt(e){e.directive("modal",{priority:10,init(r,i,o){G();let n=o||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${n}`,r.setAttribute("data-modal-id",n),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let d=r.querySelector("h1, h2, h3, h4, h5, h6");d&&(d.id||(d.id=`nojs-modal-heading-${n}`),r.setAttribute("aria-labelledby",d.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let l=r.getAttribute("modal-class"),f=r.getAttribute("modal-escape"),p=h=>{h.target===r&&s!=="false"&&f!=="false"&&W(r,n)};r.addEventListener("click",p),I.set(n,r);let m=h=>{if(h.newState==="open"){if(r.style.zIndex=String(It()),l&&l.split(/\s+/).filter(Boolean).forEach(c=>r.classList.add(c)),requestAnimationFrame(()=>{let c=r.querySelector(Pt);c?c.focus():r.focus()}),or(r),f!=="false"){let c=a=>{a.key==="Escape"&&(a.stopPropagation(),W(r,n))};r.addEventListener("keydown",c),X.set(r,c)}}else if(h.newState==="closed"){l&&l.split(/\s+/).filter(Boolean).forEach(u=>r.classList.remove(u)),Ft(r);let c=X.get(r);c&&(r.removeEventListener("keydown",c),X.delete(r));let a=C.findIndex(u=>u.id===n);if(a!==-1){let u=C[a];C.splice(a,1),u.triggerEl&&requestAnimationFrame(()=>{u.triggerEl.focus()})}}};r.addEventListener("toggle",m),rr(r,()=>{r.removeEventListener("click",p),r.removeEventListener("toggle",m),Ft(r);let h=X.get(r);h&&(r.removeEventListener("keydown",h),X.delete(r)),I.delete(n);let c=C.findIndex(a=>a.id===n);c!==-1&&C.splice(c,1)})}});let t=r=>t.open(r);t.open=r=>{let i=I.get(r);if(!i)return!1;C.push({id:r,el:i,triggerEl:null});try{i.showPopover()}catch{return!1}return!0},t.close=r=>{let i=I.get(r);return i?(W(i,r),!0):!1},t.closeAll=()=>{for(let r=C.length-1;r>=0;r--)W(C[r].el,C[r].id)},e.modal=t}function W(e,t){try{e.hidePopover()}catch{}}function nr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function qt(e){e.directive("modal-open",{priority:10,init(t,r,i){G();let o=i;if(!o){let m=(t.closest("[use]")||t.parentElement)?.querySelector("[data-modal-id]");if(m&&(o=m.getAttribute("data-modal-id")),!o){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}t.setAttribute("aria-haspopup","dialog"),t.setAttribute("aria-expanded","false");let n=()=>{let p=I.get(o)||document.querySelector(`[data-modal-id="${o}"]`);if(!p){console.warn(`[modal-open] modal "${o}" not found`);return}C.push({id:o,el:p,triggerEl:t}),t.setAttribute("aria-expanded","true"),p.id&&t.setAttribute("aria-controls",p.id);try{p.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${o}"`)}},d=()=>{t.setAttribute("aria-expanded","false")},s=null,l=null;requestAnimationFrame(()=>{let p=I.get(o);p&&(l=p,s=m=>{m.newState==="closed"&&t.setAttribute("aria-expanded","false")},p.addEventListener("toggle",s))}),t.addEventListener("click",n),nr(t,()=>{t.removeEventListener("click",n),l&&s&&l.removeEventListener("toggle",s)})}})}function ir(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Bt(e){e.directive("modal-close",{priority:10,init(t,r,i){G();let o=()=>{let n,d;if(i){if(d=i,n=I.get(d),!n){console.warn(`[modal-close] modal "${d}" not found`);return}}else{if(n=t.closest("[modal]"),!n){console.warn("[modal-close] no parent modal found");return}d=n.getAttribute("modal")}W(n,d)};t.addEventListener("click",o),ir(t,()=>{t.removeEventListener("click",o)})}})}function Ht(e,t={}){Mt(e),qt(e),Bt(e)}function $t(){zt()}var M={openMenus:new Map};function Rt(){M.openMenus.clear()}function V(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let e=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-dropdown",""),t.textContent=e,document.head.appendChild(t)}var sr=0;function ar(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Ot(e,t,r){let i=r.getAttribute("dropdown-position")||"bottom",o=r.getAttribute("dropdown-align")||"start";e.style.top="",e.style.left="";let n=t.getBoundingClientRect(),d=e.getBoundingClientRect(),s=window.innerHeight,l=window.innerWidth,f,p;switch(i){case"top":f=n.top-d.height,p=n.left;break;case"left":f=n.top,p=n.left-d.width;break;case"right":f=n.top,p=n.right;break;default:f=n.bottom,p=n.left}i==="bottom"||i==="top"?o==="end"&&(p=n.right-d.width):o==="end"&&(f=n.bottom-d.height),i==="bottom"&&f+d.height>s&&n.top-d.height>0?f=n.top-d.height:i==="top"&&f<0&&n.bottom+d.height<=s&&(f=n.bottom),p<4&&(p=4),p+d.width>l-4&&(p=l-d.width-4),e.style.top=`${f}px`,e.style.left=`${p}px`}function mt(e){return[...e.querySelectorAll("[dropdown-item]")].filter(t=>!t.hasAttribute("disabled")&&t.getAttribute("aria-disabled")!=="true")}function ft(e){let t=mt(e);t.length&&t[0].focus()}function Gt(e){let t=mt(e);t.length&&t[t.length-1].focus()}function Wt(e){e.directive("dropdown",{priority:15,init(r){V()}}),e.directive("dropdown-toggle",{priority:15,init(r){V();let i=r.closest("[dropdown]");if(!i)return;let o=i.querySelector("[dropdown-menu]");if(!o)return;r.setAttribute("aria-haspopup","menu"),r.setAttribute("aria-expanded","false"),o.classList.add("nojs-dropdown-menu"),o.setAttribute("role","menu"),o.setAttribute("popover","auto"),o.id||(o.id=`nojs-dd-menu-${Date.now()}-${sr++}`),r.setAttribute("aria-controls",o.id);let n=!1,d=typeof o.showPopover=="function"&&typeof o.hidePopover=="function";function s(){if(o.setAttribute("data-open",""),d&&!n)try{o.showPopover(),n=!0}catch{n=!1}r.setAttribute("aria-expanded","true"),Ot(o,r,i),M.openMenus.set(o,{toggle:r,wrapper:i})}function l(){if(d&&n){n=!1;try{o.hidePopover()}catch{}}o.removeAttribute("data-open"),r.setAttribute("aria-expanded","false"),M.openMenus.delete(o)}function f(){return r.getAttribute("aria-expanded")==="true"}let p=g=>{g.newState==="closed"&&f()&&l()};o.addEventListener("toggle",p);let m=g=>{g.preventDefault(),g.stopPropagation(),f()?l():s()};r.addEventListener("click",m);let h=g=>{f()&&!i.contains(g.target)&&l()};document.addEventListener("click",h,!0);let c=g=>{g.key==="Escape"&&f()&&(l(),r.focus())};document.addEventListener("keydown",c);let a=g=>{switch(g.key){case"Enter":case" ":g.preventDefault(),s(),ft(o);break;case"ArrowDown":g.preventDefault(),s(),ft(o);break;case"ArrowUp":g.preventDefault(),s(),Gt(o);break}};r.addEventListener("keydown",a);let u=g=>{if(!(!f()||mt(o).find(D=>D===document.activeElement)))switch(g.key){case"ArrowDown":g.preventDefault(),ft(o);break;case"ArrowUp":g.preventDefault(),Gt(o);break}};o.addEventListener("keydown",u);let b=()=>{f()&&Ot(o,r,i)};window.addEventListener("scroll",b,!0),window.addEventListener("resize",b),ar(r,()=>{r.removeEventListener("click",m),r.removeEventListener("keydown",a),o.removeEventListener("keydown",u),o.removeEventListener("toggle",p),document.removeEventListener("click",h,!0),document.removeEventListener("keydown",c),window.removeEventListener("scroll",b,!0),window.removeEventListener("resize",b),M.openMenus.delete(o)})}}),e.directive("dropdown-menu",{priority:15,init(r){V(),r.hasAttribute("role")||r.setAttribute("role","menu")}});let t=r=>t.open(r);t.open=r=>{let i=document.getElementById(r);if(!i)return!1;let n=i.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!n||n.getAttribute("aria-expanded")==="true"?!1:(n.click(),!0)},t.close=r=>{let i=document.getElementById(r);if(!i)return!1;let n=i.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!n||n.getAttribute("aria-expanded")!=="true"?!1:(n.click(),!0)},e.dropdown=t}function Vt(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function cr(e){return[...e.querySelectorAll("[dropdown-item]")].filter(t=>!t.hasAttribute("disabled")&&t.getAttribute("aria-disabled")!=="true")}function bt(e,t){if(!e)return;if(typeof e.hidePopover=="function")try{e.hidePopover()}catch{}e.removeAttribute("data-open");let r=t&&t.querySelector("[dropdown-toggle]");r&&r.setAttribute("aria-expanded","false"),M.openMenus.has(e)&&M.openMenus.delete(e)}function Kt(e){e.directive("dropdown-item",{priority:15,init(t){V();let r=t.closest("[dropdown-menu]"),i=t.closest("[dropdown]");t.setAttribute("role","menuitem"),t.setAttribute("tabindex","-1"),t.classList.add("nojs-dropdown-item"),t.hasAttribute("disabled")&&t.setAttribute("aria-disabled","true");let o=d=>{if(!r)return;let s=cr(r),l=s.indexOf(t);switch(d.key){case"ArrowDown":{d.preventDefault(),(l+1<s.length?s[l+1]:s[0]).focus();break}case"ArrowUp":{d.preventDefault(),(l-1>=0?s[l-1]:s[s.length-1]).focus();break}case"Home":{d.preventDefault(),s.length&&s[0].focus();break}case"End":{d.preventDefault(),s.length&&s[s.length-1].focus();break}case"Enter":{d.preventDefault(),t.click();break}case"Escape":{if(d.preventDefault(),bt(r,i),i){let f=i.querySelector("[dropdown-toggle]");f&&f.focus()}break}case"Tab":{bt(r,i);break}}};t.addEventListener("keydown",o),Vt(t,()=>t.removeEventListener("keydown",o));let n=()=>{if(bt(r,i),i){let d=i.querySelector("[dropdown-toggle]");d&&d.focus()}};t.addEventListener("click",n),Vt(t,()=>t.removeEventListener("click",n))}})}function Ut(e,t={}){Wt(e),Kt(e)}function Yt(){Rt()}var z=new Map,K=new Set,Xt=0;function Nt(){return++Xt}function Zt(){for(let e of K)clearTimeout(e);K.clear();for(let e of z.values())e.remove();z.clear(),Xt=0}function Qt(){if(typeof document>"u"||document.querySelector("style[data-nojs-toast]"))return;let e=`
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-toast",""),t.textContent=e,document.head.appendChild(t)}function gt(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var dr=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function ht(){return z.size>0?z.values().next().value:lr("top-right")}function lr(e){if(z.has(e))return z.get(e);let t=document.createElement("div");return t.classList.add("nojs-toast-container"),t.setAttribute("data-position",e),t.setAttribute("role","log"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-relevant","additions"),document.body.appendChild(t),z.set(e,t),t}function pr(e){return e.startsWith("top")}function vt(e,t,r,i,o){let n=Nt(),d=e.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",n),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let l=document.createElement("span");if(l.textContent=t,s.appendChild(l),o){let f=document.createElement("button");f.type="button",f.classList.add("nojs-toast-dismiss"),f.setAttribute("aria-label","Dismiss"),f.textContent="\xD7",f.addEventListener("click",()=>et(s)),s.appendChild(f)}if(pr(d)&&e.firstChild?e.insertBefore(s,e.firstChild):e.appendChild(s),i>0){let f=setTimeout(()=>{K.delete(f),et(s)},i);K.add(f),s._toastTimerId=f}return s}function et(e){!e||!e.isConnected||(e._toastTimerId!=null&&(clearTimeout(e._toastTimerId),K.delete(e._toastTimerId)),e.remove())}function Jt(e){Qt(),e.directive("toast-container",{priority:10,init(r,i,o){let n=o&&dr.has(o)?o:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",n),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),z.set(n,r),gt(r,()=>{z.get(n)===r&&z.delete(n)})}}),e.directive("toast",{priority:10,init(r,i,o){if(!o)return;let n=r.getAttribute("toast-type")||"info",d=parseInt(r.getAttribute("toast-duration"),10)||3e3,s=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let c=()=>{let a=ht();vt(a,o,n,d,s)};r.addEventListener("click",c),gt(r,()=>r.removeEventListener("click",c));return}let f=e.findContext(r),p;function m(){let c=e.evaluate(o,f);if(c&&c!==p){let a=typeof c=="string"?c:String(c),u=ht();vt(u,a,n,d,s)}p=c}let h=f.$watch(m);gt(r,h)}});let t=(r,i="info",o=3e3)=>{if(typeof document>"u")return;let n=!0,d=ht();return vt(d,String(r),i,o,n)};t.dismiss=r=>{let i=document.querySelector(`[data-toast-id="${r}"]`);i&&et(i)},t.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>et(r))},e.toast=t}function te(e,t={}){Jt(e)}function ee(){Zt()}var q={containers:new Map};function re(){q.containers.clear()}function oe(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let e=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tabs",""),t.textContent=e,document.head.appendChild(t)}function ur(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var fr=0;function ne(e){return`${e}-${++fr}`}function yt(e,t){let r=q.containers.get(e);if(!r)return;let{tabs:i,panels:o}=r;if(!(t<0||t>=i.length)&&i[t].getAttribute("aria-disabled")!=="true"){for(let n=0;n<i.length;n++)i[n].setAttribute("aria-selected","false"),i[n].setAttribute("tabindex","-1"),o[n].setAttribute("aria-hidden","true"),o[n].inert=!0;i[t].setAttribute("aria-selected","true"),i[t].setAttribute("tabindex","0"),o[t].setAttribute("aria-hidden","false"),o[t].inert=!1,r.activeIndex=t}}function N(e,t,r){let i=e.length,o=t;for(let n=0;n<i;n++)if(o=(o+r+i)%i,e[o].getAttribute("aria-disabled")!=="true")return o;return t}function ie(e){e.directive("tabs",{priority:10,init(t,r,i){oe();let o=[],n=[];for(let a of Array.from(t.children))a.hasAttribute("tab")?o.push(a):a.hasAttribute("panel")&&n.push(a);if(o.length===0){console.warn("[tabs] No child [tab] elements found.");return}o.length!==n.length&&console.warn("[tabs] Mismatch: "+o.length+" tabs but "+n.length+" panels.");let d=t.getAttribute("tab-position")||"top";t.setAttribute("data-position",d),t.classList.add("nojs-tabs");let s=document.createElement("div");s.setAttribute("role","tablist"),s.classList.add("nojs-tablist");let l=Math.min(o.length,n.length);for(let a=0;a<l;a++){let u=o[a],b=n[a],g=u.id||ne("nojs-tab"),y=b.id||ne("nojs-panel");u.id=g,b.id=y,u.setAttribute("role","tab"),u.setAttribute("aria-selected","false"),u.setAttribute("aria-controls",y),u.setAttribute("tabindex","-1"),u.classList.add("nojs-tab"),b.setAttribute("role","tabpanel"),b.setAttribute("aria-labelledby",g),b.setAttribute("tabindex","0"),b.setAttribute("aria-hidden","true"),b.inert=!0,b.classList.add("nojs-panel"),s.appendChild(u)}let f=n[0];f?t.insertBefore(s,f):t.appendChild(s),q.containers.set(t,{tabs:o.slice(0,l),panels:n.slice(0,l),activeIndex:-1});let p=e.findContext(t);for(let a=0;a<l;a++){let u=o[a].getAttribute("tab-disabled");u&&e.evaluate(u,p)&&o[a].setAttribute("aria-disabled","true")}let m=0;if(i&&i.trim()!==""){let a=parseInt(i,10);!isNaN(a)&&a>=0&&a<l&&(m=a)}o[m]?.getAttribute("aria-disabled")==="true"&&(m=N(o.slice(0,l),m,1)),yt(t,m);let h=a=>{let u=q.containers.get(t);if(!u)return;let b=a.target;if(b.getAttribute("role")!=="tab")return;let{tabs:g}=u,y=g.indexOf(b);if(y===-1)return;let w=-1;switch(a.key){case"ArrowRight":case"ArrowDown":w=N(g,y,1);break;case"ArrowLeft":case"ArrowUp":w=N(g,y,-1);break;case"Home":w=N(g,g.length-1,1);break;case"End":w=N(g,0,-1);break;case"Tab":return;default:return}w!==-1&&w!==y&&(a.preventDefault(),yt(t,w),g[w].focus())};s.addEventListener("keydown",h);let c=a=>{let u=a.target.closest("[role='tab']");if(!u)return;let b=q.containers.get(t);if(!b)return;let g=b.tabs.indexOf(u);g!==-1&&(yt(t,g),u.focus())};s.addEventListener("click",c),ur(t,()=>{s.removeEventListener("keydown",h),s.removeEventListener("click",c),q.containers.delete(t)})}})}function se(e){e.directive("tab",{priority:11,init(){}}),e.directive("tab-disabled",{priority:11,init(){}}),e.directive("tab-position",{priority:11,init(){}})}function ae(e){e.directive("panel",{priority:11,init(){}})}function ce(e,t={}){ie(e),se(e),ae(e)}function de(){re()}var A={branches:new Map,selectedItem:null,typeahead:"",typeaheadTimer:null};function le(){A.branches.clear(),A.selectedItem=null,A.typeahead="",A.typeaheadTimer&&(clearTimeout(A.typeaheadTimer),A.typeaheadTimer=null)}function rt(){if(typeof document>"u"||document.querySelector("style[data-nojs-tree]"))return;let e=`
.nojs-tree {
  list-style: none;
  padding-left: 0;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-table",""),t.textContent=e,document.head.appendChild(t)}function Ar(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Er(e,t){let r=e.querySelector("tbody");if(!r)return null;let i=null;if(r.hasAttribute("each")||r.hasAttribute("foreach")?i=r:i=r.querySelector("[each]")||r.querySelector("[foreach]"),!i)return null;let o=i.getAttribute("each")||i.getAttribute("foreach");if(!o)return null;let n=o.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return n?{iteratorVar:n[1],arrayPath:n[2].trim()}:null}function jr(e,t){let r=t.split("."),i=e;for(let o of r){if(i==null)return;i=i[o]}return i}function Fe(e,t,r){let i=t.split("."),o=e;for(let n=0;n<i.length-1;n++){if(o[i[n]]==null)return;o=o[i[n]]}o[i[i.length-1]]=r}function Me(e,t,r){if(e==null&&t==null)return 0;if(e==null)return-1;if(t==null)return 1;switch(r){case"number":return Number(e)-Number(t);case"date":return new Date(e).getTime()-new Date(t).getTime();default:return String(e).localeCompare(String(t))}}function kr(e){let t=e.querySelectorAll("th[data-sortable]");for(let r of t)r.removeAttribute("data-sort-dir"),r.setAttribute("aria-sort","none")}function qe(e){e.directive("sortable",{priority:10,init(t){Q(),t.classList.add("nojs-sortable")}})}function Be(e){e.directive("sort",{priority:11,init(t,r,i){Q();let o=i;if(!o)return;let n=t.getAttribute("sort-type")||"string",d=t.getAttribute("sort-default");t.setAttribute("data-sortable",""),t.setAttribute("aria-sort","none");let s=t.closest("table");if(!s)return;U.sorts.has(s)||U.sorts.set(s,{column:null,direction:null}),(d==="asc"||d==="desc")&&Pe(t,s,o,n,d,e);let l=()=>{let f=U.sorts.get(s),p;f.column!==o?p="asc":f.direction==="asc"?p="desc":f.direction==="desc"?p=null:p="asc",Pe(t,s,o,n,p,e)};t.addEventListener("click",l),Ar(t,()=>{t.removeEventListener("click",l),s&&s._nojsOriginalOrder&&delete s._nojsOriginalOrder})}})}function Pe(e,t,r,i,o,n){let d=U.sorts.get(t);kr(t),o?(e.setAttribute("data-sort-dir",o),e.setAttribute("aria-sort",o==="asc"?"ascending":"descending"),d.column=r,d.direction=o):(d.column=null,d.direction=null);let s=Er(t,n);if(s){let l=n.findContext(t),f=l?jr(l,s.arrayPath):null;if(Array.isArray(f)){if(!o){let m=t._nojsOriginalOrder;if(m){let h=new Set(f),c=m.filter(a=>h.has(a));for(let a of f)m.includes(a)||c.push(a);Fe(l,s.arrayPath,c)}return}t._nojsOriginalOrder||(t._nojsOriginalOrder=[...f]);let p=[...f].sort((m,h)=>{let c=m!=null?m[r]:null,a=h!=null?h[r]:null,u=Me(c,a,i);return o==="desc"?-u:u});Fe(l,s.arrayPath,p);return}}_r(t,e,r,i,o)}function _r(e,t,r,i,o){let n=e.querySelector("tbody");if(!n)return;let l=[...t.closest("tr").children].indexOf(t);if(l<0)return;let f=[...n.querySelectorAll(":scope > tr")];if(e._nojsOriginalRows||(e._nojsOriginalRows=[...f]),!o){let m=document.createDocumentFragment();for(let h of e._nojsOriginalRows)m.appendChild(h);n.appendChild(m);return}f.sort((m,h)=>{let c=m.children[l]?.textContent?.trim()||"",a=h.children[l]?.textContent?.trim()||"",u=Me(i==="number"?parseFloat(c.replace(/[^0-9.\-]/g,""))||0:c,i==="number"?parseFloat(a.replace(/[^0-9.\-]/g,""))||0:a,i);return o==="desc"?-u:u});let p=document.createDocumentFragment();for(let m of f)p.appendChild(m);n.appendChild(p)}function He(e){e.directive("fixed-header",{priority:10,init(t){Q(),t.classList.add("nojs-fixed-header")}})}function $e(e){e.directive("fixed-col",{priority:10,init(t){Q(),t.classList.add("nojs-fixed-col")}})}function Re(e,t={}){qe(e),Be(e),He(e),$e(e)}function Oe(){ze()}var Sr={name:"nojs-elements",install(e,t={}){_t(e,t),Tt(e,t),Ht(e,t),Ut(e,t),te(e,t),ce(e,t),ge(e,t),we(e,t),_e(e,t),De(e,t),Re(e,t)},dispose(e){St(),Dt(),$t(),Yt(),ee(),de(),he(),Ae(),Ie(),Oe()}},Lr=Sr;
