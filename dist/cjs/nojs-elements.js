 ...
 * @license MIT
 */
var ct=Object.defineProperty;var Oe=Object.getOwnPropertyDescriptor;var Ge=Object.getOwnPropertyNames;var We=Object.prototype.hasOwnProperty;var Ve=(e,t)=>{for(var r in t)ct(e,r,{get:t[r],enumerable:!0})},Ue=(e,t,r,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of Ge(t))!We.call(e,o)&&o!==r&&ct(e,o,{get:()=>t[o],enumerable:!(i=Oe(t,o))||i.enumerable});return e};var Ke=e=>Ue(ct({},"__esModule",{value:!0}),e);var Lr={};Ve(Lr,{default:()=>Sr});module.exports=Ke(Lr);var K=new Map,C=new Map;function wt(){for(let e of C.values())clearTimeout(e);C.clear();for(let e of K.values())e.remove();K.clear()}function At(){if(typeof document>"u"||document.querySelector("style[data-nojs-tooltip]"))return;let e=`
.nojs-tooltip {
  position: fixed;
  z-index: 9999;
  pointer-events: none;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tooltip",""),t.textContent=e,document.head.appendChild(t)}function Ye(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var N=8;function Xe(e,t,r){let i=t.getBoundingClientRect(),o=e.getBoundingClientRect(),n=window.innerWidth,d=window.innerHeight,s,l;switch(r){case"bottom":s=i.bottom+N,l=i.left+(i.width-o.width)/2;break;case"left":s=i.top+(i.height-o.height)/2,l=i.left-o.width-N;break;case"right":s=i.top+(i.height-o.height)/2,l=i.right+N;break;default:s=i.top-o.height-N,l=i.left+(i.width-o.width)/2;break}l<4&&(l=4),l+o.width>n-4&&(l=n-o.width-4),s<4&&(s=4),s+o.height>d-4&&(s=d-o.height-4),e.style.top=`${s}px`,e.style.left=`${l}px`}var Ze=0;function Ne(e,t,r){document.body.appendChild(t),Xe(t,e,r),t.setAttribute("aria-hidden","false")}function Qe(e,t){t.setAttribute("aria-hidden","true"),t.remove()}function Et(e){e.directive("tooltip",{priority:20,init(t,r,i){At();let o=i;if(!o){console.warn("[tooltip] attribute value (tooltip text) is required.");return}let n=t.getAttribute("tooltip-position")||"top",d=parseInt(t.getAttribute("tooltip-delay"),10)||300,s=t.getAttribute("tooltip-disabled"),l=s?e.findContext(t):null,f=`nojs-tooltip-${++Ze}`,p=document.createElement("div");p.className="nojs-tooltip",p.setAttribute("role","tooltip"),p.setAttribute("id",f),p.setAttribute("aria-hidden","true"),p.textContent=o,t.setAttribute("aria-describedby",f),K.set(t,p);let m=()=>{if(s&&l&&e.evaluate(s,l))return;C.has(t)&&clearTimeout(C.get(t));let y=setTimeout(()=>{C.delete(t),!(s&&l&&e.evaluate(s,l))&&Ne(t,p,n)},d);C.set(t,y)},h=()=>{C.has(t)&&(clearTimeout(C.get(t)),C.delete(t)),Qe(t,p)},c=()=>m(),a=()=>h(),u=()=>m(),b=()=>h(),g=y=>{y.key==="Escape"&&p.getAttribute("aria-hidden")==="false"&&h()};t.addEventListener("mouseenter",c),t.addEventListener("mouseleave",a),t.addEventListener("focusin",u),t.addEventListener("focusout",b),t.addEventListener("keydown",g),Ye(t,()=>{t.removeEventListener("mouseenter",c),t.removeEventListener("mouseleave",a),t.removeEventListener("focusin",u),t.removeEventListener("focusout",b),t.removeEventListener("keydown",g),C.has(t)&&(clearTimeout(C.get(t)),C.delete(t)),p.remove(),K.delete(t)})}})}function jt(e,t={}){Et(e)}function _t(){wt()}var k=new Map;function kt(){k.clear()}function Q(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let e=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-popover",""),t.textContent=e,document.head.appendChild(t)}function dt(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var H=8;function lt(e,t,r){let i=t.getBoundingClientRect(),o=e.getBoundingClientRect(),n=window.innerWidth,d=window.innerHeight,s,l;switch(r){case"top":s=i.top-o.height-H,l=i.left+(i.width-o.width)/2;break;case"left":s=i.top+(i.height-o.height)/2,l=i.left-o.width-H;break;case"right":s=i.top+(i.height-o.height)/2,l=i.right+H;break;default:s=i.bottom+H,l=i.left+(i.width-o.width)/2;break}r==="bottom"&&s+o.height>d&&(s=i.top-o.height-H),r==="top"&&s<0&&(s=i.bottom+H),l<4&&(l=4),l+o.width>n-4&&(l=n-o.width-4),s<4&&(s=4),s+o.height>d-4&&(s=d-o.height-4),e.style.top=`${s}px`,e.style.left=`${l}px`}function St(e){e.directive("popover",{priority:20,init(r,i,o){Q();let n=o||r.getAttribute("id")||`nojs-popover-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("data-popover-id",n),r.setAttribute("popover","auto"),r.classList.add("nojs-popover");let d=r.getAttribute("popover-position")||"bottom";if(!k.has(n))k.set(n,{popoverEl:r,triggerEls:new Set,position:d,open:!1});else{let l=k.get(n);l.popoverEl=r,l.position=d}let s=l=>{let f=k.get(n);if(!f)return;let p=l.newState==="open";f.open=p;for(let m of f.triggerEls)m.setAttribute("aria-expanded",String(p))};r.addEventListener("toggle",s),dt(r,()=>{r.removeEventListener("toggle",s),k.delete(n)})}}),e.directive("popover-trigger",{priority:20,init(r,i,o){Q();let n=o;if(!n){let f=(r.closest("[use]")||r.parentElement)?.querySelector("[data-popover-id]");if(f&&(n=f.getAttribute("data-popover-id")),!n){console.warn("[popover-trigger] attribute value (popover ID) is required.");return}}r.setAttribute("aria-haspopup","true"),r.setAttribute("aria-expanded","false"),r.setAttribute("aria-controls",n),k.has(n)||k.set(n,{popoverEl:null,triggerEls:new Set,position:"bottom",open:!1}),k.get(n).triggerEls.add(r);let d=l=>{let f=k.get(n);if(!f||!f.popoverEl){console.warn(`[popover-trigger] no popover found with id "${n}".`);return}f.popoverEl.togglePopover(),requestAnimationFrame(()=>{f.popoverEl.matches(":popover-open")&&lt(f.popoverEl,r,f.position)})};r.addEventListener("click",d);let s=l=>{let f=k.get(n);l.key==="Escape"&&f?.open&&(f.popoverEl.hidePopover(),r.focus())};document.addEventListener("keydown",s),dt(r,()=>{r.removeEventListener("click",d),document.removeEventListener("keydown",s);let l=k.get(n);l&&l.triggerEls.delete(r)})}}),e.directive("popover-dismiss",{priority:20,init(r){Q();let i=()=>{let o=r.closest(".nojs-popover");o&&o.hidePopover()};r.addEventListener("click",i),dt(r,()=>r.removeEventListener("click",i))}});let t=(r,i)=>t.open(r,i);t.open=(r,i)=>{let o=k.get(r);if(!o||!o.popoverEl)return!1;try{o.popoverEl.showPopover()}catch{return!1}let n=i||[...o.triggerEls][0];return n&&requestAnimationFrame(()=>lt(o.popoverEl,n,o.position)),!0},t.close=r=>{let i=k.get(r);if(!i||!i.popoverEl)return!1;try{i.popoverEl.hidePopover()}catch{}return!0},t.toggle=(r,i)=>{let o=k.get(r);if(!o||!o.popoverEl)return!1;o.popoverEl.togglePopover();let n=i||[...o.triggerEls][0];return n&&o.popoverEl.matches(":popover-open")&&requestAnimationFrame(()=>lt(o.popoverEl,n,o.position)),!0},e.popover=t}function Lt(e,t={}){St(e)}function Ct(){kt()}var L=[],D=new Map,Je=1e4;function Tt(){return Je+L.length}function Dt(){L.length=0,D.clear()}function $(){if(typeof document>"u"||document.querySelector("style[data-nojs-modal]"))return;let e=`
.nojs-modal {
  position: fixed;
  inset: 0;
  display: none;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-modal",""),t.textContent=e,document.head.appendChild(t)}function tr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var zt='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',pt=new WeakMap;function er(e){let t=r=>{if(r.key!=="Tab")return;let i=[...e.querySelectorAll(zt)].filter(d=>d.offsetParent!==null);if(i.length===0){r.preventDefault();return}let o=i[0],n=i[i.length-1];r.shiftKey?document.activeElement===o&&(r.preventDefault(),n.focus()):document.activeElement===n&&(r.preventDefault(),o.focus())};e.addEventListener("keydown",t),pt.set(e,t)}function It(e){let t=pt.get(e);t&&(e.removeEventListener("keydown",t),pt.delete(e))}var Y=new WeakMap;function Ft(e){e.directive("modal",{priority:10,init(r,i,o){$();let n=o||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${n}`,r.setAttribute("data-modal-id",n),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let d=r.querySelector("h1, h2, h3, h4, h5, h6");d&&(d.id||(d.id=`nojs-modal-heading-${n}`),r.setAttribute("aria-labelledby",d.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let l=r.getAttribute("modal-class"),f=r.getAttribute("modal-escape"),p=h=>{h.target===r&&s!=="false"&&f!=="false"&&R(r,n)};r.addEventListener("click",p),D.set(n,r);let m=h=>{if(h.newState==="open"){if(r.style.zIndex=String(Tt()),l&&l.split(/\s+/).filter(Boolean).forEach(c=>r.classList.add(c)),requestAnimationFrame(()=>{let c=r.querySelector(zt);c?c.focus():r.focus()}),er(r),f!=="false"){let c=a=>{a.key==="Escape"&&(a.stopPropagation(),R(r,n))};r.addEventListener("keydown",c),Y.set(r,c)}}else if(h.newState==="closed"){l&&l.split(/\s+/).filter(Boolean).forEach(u=>r.classList.remove(u)),It(r);let c=Y.get(r);c&&(r.removeEventListener("keydown",c),Y.delete(r));let a=L.findIndex(u=>u.id===n);if(a!==-1){let u=L[a];L.splice(a,1),u.triggerEl&&requestAnimationFrame(()=>{u.triggerEl.focus()})}}};r.addEventListener("toggle",m),tr(r,()=>{r.removeEventListener("click",p),r.removeEventListener("toggle",m),It(r);let h=Y.get(r);h&&(r.removeEventListener("keydown",h),Y.delete(r)),D.delete(n);let c=L.findIndex(a=>a.id===n);c!==-1&&L.splice(c,1)})}});let t=r=>t.open(r);t.open=r=>{let i=D.get(r);if(!i)return!1;L.push({id:r,el:i,triggerEl:null});try{i.showPopover()}catch{return!1}return!0},t.close=r=>{let i=D.get(r);return i?(R(i,r),!0):!1},t.closeAll=()=>{for(let r=L.length-1;r>=0;r--)R(L[r].el,L[r].id)},e.modal=t}function R(e,t){try{e.hidePopover()}catch{}}function rr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Pt(e){e.directive("modal-open",{priority:10,init(t,r,i){$();let o=i;if(!o){let m=(t.closest("[use]")||t.parentElement)?.querySelector("[data-modal-id]");if(m&&(o=m.getAttribute("data-modal-id")),!o){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}t.setAttribute("aria-haspopup","dialog"),t.setAttribute("aria-expanded","false");let n=()=>{let p=D.get(o)||document.querySelector(`[data-modal-id="${o}"]`);if(!p){console.warn(`[modal-open] modal "${o}" not found`);return}L.push({id:o,el:p,triggerEl:t}),t.setAttribute("aria-expanded","true"),p.id&&t.setAttribute("aria-controls",p.id);try{p.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${o}"`)}},d=()=>{t.setAttribute("aria-expanded","false")},s=null,l=null;requestAnimationFrame(()=>{let p=D.get(o);p&&(l=p,s=m=>{m.newState==="closed"&&t.setAttribute("aria-expanded","false")},p.addEventListener("toggle",s))}),t.addEventListener("click",n),rr(t,()=>{t.removeEventListener("click",n),l&&s&&l.removeEventListener("toggle",s)})}})}function or(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Mt(e){e.directive("modal-close",{priority:10,init(t,r,i){$();let o=()=>{let n,d;if(i){if(d=i,n=D.get(d),!n){console.warn(`[modal-close] modal "${d}" not found`);return}}else{if(n=t.closest("[modal]"),!n){console.warn("[modal-close] no parent modal found");return}d=n.getAttribute("modal")}R(n,d)};t.addEventListener("click",o),or(t,()=>{t.removeEventListener("click",o)})}})}function qt(e,t={}){Ft(e),Pt(e),Mt(e)}function Bt(){Dt()}var P={openMenus:new Map};function Ht(){P.openMenus.clear()}function O(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let e=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-toast",""),t.textContent=e,document.head.appendChild(t)}function bt(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var ar=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function gt(){return I.size>0?I.values().next().value:cr("top-right")}function cr(e){if(I.has(e))return I.get(e);let t=document.createElement("div");return t.classList.add("nojs-toast-container"),t.setAttribute("data-position",e),t.setAttribute("role","log"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-relevant","additions"),document.body.appendChild(t),I.set(e,t),t}function dr(e){return e.startsWith("top")}function ht(e,t,r,i,o){let n=Yt(),d=e.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",n),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let l=document.createElement("span");if(l.textContent=t,s.appendChild(l),o){let f=document.createElement("button");f.type="button",f.classList.add("nojs-toast-dismiss"),f.setAttribute("aria-label","Dismiss"),f.textContent="\xD7",f.addEventListener("click",()=>J(s)),s.appendChild(f)}if(dr(d)&&e.firstChild?e.insertBefore(s,e.firstChild):e.appendChild(s),i>0){let f=setTimeout(()=>{G.delete(f),J(s)},i);G.add(f),s._toastTimerId=f}return s}function J(e){!e||!e.isConnected||(e._toastTimerId!=null&&(clearTimeout(e._toastTimerId),G.delete(e._toastTimerId)),e.remove())}function Nt(e){Zt(),e.directive("toast-container",{priority:10,init(r,i,o){let n=o&&ar.has(o)?o:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",n),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),I.set(n,r),bt(r,()=>{I.get(n)===r&&I.delete(n)})}}),e.directive("toast",{priority:10,init(r,i,o){if(!o)return;let n=r.getAttribute("toast-type")||"info",d=parseInt(r.getAttribute("toast-duration"),10)||3e3,s=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let c=()=>{let a=gt();ht(a,o,n,d,s)};r.addEventListener("click",c),bt(r,()=>r.removeEventListener("click",c));return}let f=e.findContext(r),p;function m(){let c=e.evaluate(o,f);if(c&&c!==p){let a=typeof c=="string"?c:String(c),u=gt();ht(u,a,n,d,s)}p=c}let h=f.$watch(m);bt(r,h)}});let t=(r,i="info",o=3e3)=>{if(typeof document>"u")return;let n=!0,d=gt();return ht(d,String(r),i,o,n)};t.dismiss=r=>{let i=document.querySelector(`[data-toast-id="${r}"]`);i&&J(i)},t.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>J(r))},e.toast=t}function Qt(e,t={}){Nt(e)}function Jt(){Xt()}var M={containers:new Map};function te(){M.containers.clear()}function ee(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let e=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-split",""),t.textContent=e,document.head.appendChild(t)}function gr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function ke(e){return e==="horizontal"?"clientX":"clientY"}function S(e,t){return t==="horizontal"?e.offsetWidth:e.offsetHeight}function hr(e,t){let i=(B.get(e)?.gutters||[]).reduce((o,n)=>o+S(n,t),0);return S(e,t)-i}function nt(e,t){let r=_.get(t);return r?r.min!=null&&e<r.min?r.min:r.max!=null&&e>r.max?r.max:e:e}function it(e,t,r,i){let o=S(t,i),n=S(r,i),d=_.get(t),s=_.get(r);e.setAttribute("aria-valuenow",Math.round(o)),e.setAttribute("aria-valuemin",d?.min||0),e.setAttribute("aria-valuemax",Math.round(o+n-(s?.min||0)))}function xt(e){let t=e.getAttribute("split-persist");if(!t)return;let r=B.get(e);if(!r)return;let i=r.panes.map(o=>o.style.flexBasis||"");try{localStorage.setItem(`nojs-split:${t}`,JSON.stringify(i))}catch{}}function vr(e){let t=e.getAttribute("split-persist");if(!t)return!1;try{let r=localStorage.getItem(`nojs-split:${t}`);if(!r)return!1;let i=JSON.parse(r),o=B.get(e);return!o||i.length!==o.panes.length?!1:(i.forEach((n,d)=>{n&&(o.panes[d].style.flexBasis=n,o.panes[d].style.flexGrow="0")}),!0)}catch{return!1}}function yr(e,t,r,i,o){let n=document.createElement("div");n.className="nojs-gutter",n.setAttribute("role","separator"),n.setAttribute("tabindex","0"),n.setAttribute("aria-orientation",t==="horizontal"?"vertical":"horizontal"),n.setAttribute("aria-label","Resize"),o!==6&&n.style.setProperty("--nojs-gutter-size",`${o}px`);let d=c=>{if(c.button!==0)return;c.preventDefault();let a=hr(e,t);v.active=!0,v.splitEl=e,v.gutterEl=n,v.prevPane=r,v.nextPane=i,v.direction=t,v.startPos=c[ke(t)],v.startPrevSize=S(r,t),v.startNextSize=S(i,t),v.containerSize=a,document.body.style.cursor=t==="horizontal"?"col-resize":"row-resize",document.body.style.userSelect="none",n.setPointerCapture(c.pointerId)},s=c=>{if(!v.active||v.gutterEl!==n)return;let a=c[ke(v.direction)]-v.startPos,u=nt(v.startPrevSize+a,v.prevPane),b=nt(v.startNextSize-a,v.nextPane),g=v.startPrevSize+v.startNextSize;u+b!==g&&(u!==v.startPrevSize+a?b=g-u:u=g-b),v.prevPane.style.flexBasis=`${u}px`,v.prevPane.style.flexGrow="0",v.nextPane.style.flexBasis=`${b}px`,v.nextPane.style.flexGrow="0",it(n,v.prevPane,v.nextPane,v.direction)},l=()=>{!v.active||v.gutterEl!==n||(v.active=!1,document.body.style.cursor="",document.body.style.userSelect="",xt(e),e.dispatchEvent(new CustomEvent("split-resize",{bubbles:!0,detail:{prevPane:r,nextPane:i}})))};n.addEventListener("pointerdown",d),n.addEventListener("pointermove",s),n.addEventListener("pointerup",l),n.addEventListener("pointercancel",l);let f=10,p=c=>{let a=t==="horizontal",u=0;if(a&&c.key==="ArrowRight"||!a&&c.key==="ArrowDown")u=f;else if(a&&c.key==="ArrowLeft"||!a&&c.key==="ArrowUp")u=-f;else if(c.key==="Home")u=(_.get(r)?.min||0)-S(r,t);else if(c.key==="End"){let z=_.get(i);u=S(r,t)+S(i,t)-(z?.min||0)-S(r,t)}else return;c.preventDefault();let b=S(r,t),g=S(i,t),y=b+g,w=nt(b+u,r),T=nt(y-w,i);w=y-T,r.style.flexBasis=`${w}px`,r.style.flexGrow="0",i.style.flexBasis=`${T}px`,i.style.flexGrow="0",it(n,r,i,t),xt(e)};n.addEventListener("keydown",p);let m=()=>{let c=_.get(r),a=_.get(i),u=c?.collapsible?r:a?.collapsible?i:null;if(!u)return;let b=_.get(u);if(!b)return;let g=u===r?i:r,y=S(r,t)+S(i,t);if(b.collapsed){b.collapsed=!1,u.removeAttribute("data-collapsed");let w=b.preCollapseSize||`${Math.round(y/2)}px`;u.style.flexBasis=w,u.style.flexGrow="0",g.style.flexBasis=`${y-parseFloat(w)}px`,g.style.flexGrow="0"}else b.preCollapseSize=u.style.flexBasis||`${S(u,t)}px`,b.collapsed=!0,u.setAttribute("data-collapsed","true"),u.style.flexBasis="0px",u.style.flexGrow="0",g.style.flexBasis=`${y}px`,g.style.flexGrow="0";it(n,r,i,t),xt(e),e.dispatchEvent(new CustomEvent("split-collapse",{bubbles:!0,detail:{pane:u,collapsed:b.collapsed}}))};return n.addEventListener("dblclick",m),{gutter:n,cleanup:()=>{n.removeEventListener("pointerdown",d),n.removeEventListener("pointermove",s),n.removeEventListener("pointerup",l),n.removeEventListener("pointercancel",l),n.removeEventListener("keydown",p),n.removeEventListener("dblclick",m)}}}function Se(e){e.directive("split",{priority:14,init(t,r,i){ot();let o=(i||"horizontal").trim()==="vertical"?"vertical":"horizontal",n=parseInt(t.getAttribute("split-gutter"),10)||6;t.classList.add("nojs-split"),t.setAttribute("data-direction",o);let d=Array.from(t.children).filter(p=>p.hasAttribute("pane"));if(d.length<2){console.warn(`[split] Container requires at least 2 [pane] children, found ${d.length}.`);return}d.forEach(p=>{_.get(p)||_.set(p,{size:p.getAttribute("pane")||null,min:parseInt(p.getAttribute("pane-min"),10)||0,max:parseInt(p.getAttribute("pane-max"),10)||1/0,collapsible:p.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null})});let s=[],l=[];for(let p=0;p<d.length-1;p++){let{gutter:m,cleanup:h}=yr(t,o,d[p],d[p+1],n);d[p].after(m),s.push(m),l.push(h)}B.set(t,{direction:o,gutterSize:n,panes:d,gutters:s}),vr(t)||d.forEach(p=>{let h=_.get(p)?.size;h?(p.style.flexBasis=h,p.style.flexGrow="0"):(p.style.flexGrow="1",p.style.flexBasis="0")}),requestAnimationFrame(()=>{s.forEach((p,m)=>{it(p,d[m],d[m+1],o)})}),gr(t,()=>{l.forEach(p=>p()),s.forEach(p=>p.remove()),B.delete(t),d.forEach(p=>_.delete(p)),t.classList.remove("nojs-split"),t.removeAttribute("data-direction")})}})}function xr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Le(e){e.directive("pane",{priority:15,init(t,r,i){ot(),t.classList.add("nojs-pane"),_.has(t)||_.set(t,{size:i||null,min:parseInt(t.getAttribute("pane-min"),10)||0,max:parseInt(t.getAttribute("pane-max"),10)||1/0,collapsible:t.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null});let o=_.get(t),n=t.closest("[data-direction='vertical']")?"height":"width";o.min&&(t.style[`min${n==="width"?"Width":"Height"}`]=`${o.min}px`),o.max&&o.max!==1/0&&(t.style[`max${n==="width"?"Width":"Height"}`]=`${o.max}px`),xr(t,()=>{t.classList.remove("nojs-pane"),_.delete(t),t.style.removeProperty("minWidth"),t.style.removeProperty("minHeight"),t.style.removeProperty("maxWidth"),t.style.removeProperty("maxHeight"),t.style.removeProperty("flexBasis"),t.style.removeProperty("flexGrow")})}})}function Ce(e,t={}){Se(e),Le(e)}function Te(){_e()}var W={sorts:new Map};function De(){W.sorts.clear()}function Z(){if(typeof document>"u"||document.querySelector("style[data-nojs-table]"))return;let e=`
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-table",""),t.textContent=e,document.head.appendChild(t)}function wr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Ar(e,t){let r=e.querySelector("tbody");if(!r)return null;let i=null;if(r.hasAttribute("each")||r.hasAttribute("foreach")?i=r:i=r.querySelector("[each]")||r.querySelector("[foreach]"),!i)return null;let o=i.getAttribute("each")||i.getAttribute("foreach");if(!o)return null;let n=o.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return n?{iteratorVar:n[1],arrayPath:n[2].trim()}:null}function Er(e,t){let r=t.split("."),i=e;for(let o of r){if(i==null)return;i=i[o]}return i}function Ie(e,t,r){let i=t.split("."),o=e;for(let n=0;n<i.length-1;n++){if(o[i[n]]==null)return;o=o[i[n]]}o[i[i.length-1]]=r}function Fe(e,t,r){if(e==null&&t==null)return 0;if(e==null)return-1;if(t==null)return 1;switch(r){case"number":return Number(e)-Number(t);case"date":return new Date(e).getTime()-new Date(t).getTime();default:return String(e).localeCompare(String(t))}}function jr(e){let t=e.querySelectorAll("th[data-sortable]");for(let r of t)r.removeAttribute("data-sort-dir"),r.setAttribute("aria-sort","none")}function Pe(e){e.directive("sortable",{priority:10,init(t){Z(),t.classList.add("nojs-sortable")}})}function Me(e){e.directive("sort",{priority:11,init(t,r,i){Z();let o=i;if(!o)return;let n=t.getAttribute("sort-type")||"string",d=t.getAttribute("sort-default");t.setAttribute("data-sortable",""),t.setAttribute("aria-sort","none");let s=t.closest("table");if(!s)return;W.sorts.has(s)||W.sorts.set(s,{column:null,direction:null}),(d==="asc"||d==="desc")&&ze(t,s,o,n,d,e);let l=()=>{let f=W.sorts.get(s),p;f.column!==o?p="asc":f.direction==="asc"?p="desc":f.direction==="desc"?p=null:p="asc",ze(t,s,o,n,p,e)};t.addEventListener("click",l),wr(t,()=>{t.removeEventListener("click",l),s&&s._nojsOriginalOrder&&delete s._nojsOriginalOrder})}})}function ze(e,t,r,i,o,n){let d=W.sorts.get(t);jr(t),o?(e.setAttribute("data-sort-dir",o),e.setAttribute("aria-sort",o==="asc"?"ascending":"descending"),d.column=r,d.direction=o):(d.column=null,d.direction=null);let s=Ar(t,n);if(s){let l=n.findContext(t),f=l?Er(l,s.arrayPath):null;if(Array.isArray(f)){if(!o){let m=t._nojsOriginalOrder;if(m){let h=new Set(f),c=m.filter(a=>h.has(a));for(let a of f)m.includes(a)||c.push(a);Ie(l,s.arrayPath,c)}return}t._nojsOriginalOrder||(t._nojsOriginalOrder=[...f]);let p=[...f].sort((m,h)=>{let c=m!=null?m[r]:null,a=h!=null?h[r]:null,u=Fe(c,a,i);return o==="desc"?-u:u});Ie(l,s.arrayPath,p);return}}_r(t,e,r,i,o)}function _r(e,t,r,i,o){let n=e.querySelector("tbody");if(!n)return;let l=[...t.closest("tr").children].indexOf(t);if(l<0)return;let f=[...n.querySelectorAll(":scope > tr")];if(e._nojsOriginalRows||(e._nojsOriginalRows=[...f]),!o){let m=document.createDocumentFragment();for(let h of e._nojsOriginalRows)m.appendChild(h);n.appendChild(m);return}f.sort((m,h)=>{let c=m.children[l]?.textContent?.trim()||"",a=h.children[l]?.textContent?.trim()||"",u=Fe(i==="number"?parseFloat(c.replace(/[^0-9.\-]/g,""))||0:c,i==="number"?parseFloat(a.replace(/[^0-9.\-]/g,""))||0:a,i);return o==="desc"?-u:u});let p=document.createDocumentFragment();for(let m of f)p.appendChild(m);n.appendChild(p)}function qe(e){e.directive("fixed-header",{priority:10,init(t){Z(),t.classList.add("nojs-fixed-header")}})}function Be(e){e.directive("fixed-col",{priority:10,init(t){Z(),t.classList.add("nojs-fixed-col")}})}function He(e,t={}){Pe(e),Me(e),qe(e),Be(e)}function $e(){De()}var kr={name:"nojs-elements",install(e,t={}){jt(e,t),Lt(e,t),qt(e,t),Vt(e,t),Qt(e,t),se(e,t),me(e,t),ye(e,t),je(e,t),Ce(e,t),He(e,t)},dispose(e){_t(),Ct(),Bt(),Ut(),Jt(),ae(),be(),xe(),Te(),$e()}},Sr=kr;
