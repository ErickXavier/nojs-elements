 ...
 * @license MIT
 */
var ct=Object.defineProperty;var Ge=Object.getOwnPropertyDescriptor;var Ne=Object.getOwnPropertyNames;var We=Object.prototype.hasOwnProperty;var Ve=(e,t)=>{for(var r in t)ct(e,r,{get:t[r],enumerable:!0})},Ue=(e,t,r,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of Ne(t))!We.call(e,o)&&o!==r&&ct(e,o,{get:()=>t[o],enumerable:!(i=Ge(t,o))||i.enumerable});return e};var Ke=e=>Ue(ct({},"__esModule",{value:!0}),e);var Cr={};Ve(Cr,{default:()=>Lr});module.exports=Ke(Cr);var U=new Map,C=new Map;function wt(){for(let e of C.values())clearTimeout(e);C.clear();for(let e of U.values())e.remove();U.clear()}function At(){if(typeof document>"u"||document.querySelector("style[data-nojs-tooltip]"))return;let e=`
.nojs-tooltip {
  position: fixed;
  z-index: 9999;
  pointer-events: none;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tooltip",""),t.textContent=e,document.head.appendChild(t)}function Ye(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var Z=8;function Xe(e,t,r){let i=t.getBoundingClientRect(),o=e.getBoundingClientRect(),n=window.innerWidth,d=window.innerHeight,s,l;switch(r){case"bottom":s=i.bottom+Z,l=i.left+(i.width-o.width)/2;break;case"left":s=i.top+(i.height-o.height)/2,l=i.left-o.width-Z;break;case"right":s=i.top+(i.height-o.height)/2,l=i.right+Z;break;default:s=i.top-o.height-Z,l=i.left+(i.width-o.width)/2;break}l<4&&(l=4),l+o.width>n-4&&(l=n-o.width-4),s<4&&(s=4),s+o.height>d-4&&(s=d-o.height-4),e.style.top=`${s}px`,e.style.left=`${l}px`}var Ze=0;function Qe(e,t,r){document.body.appendChild(t),Xe(t,e,r),t.setAttribute("aria-hidden","false")}function Je(e,t){t.setAttribute("aria-hidden","true"),t.remove()}function Et(e){e.directive("tooltip",{priority:20,init(t,r,i){At();let o=i;if(!o){console.warn("[tooltip] attribute value (tooltip text) is required.");return}let n=t.getAttribute("tooltip-position")||"top",d=parseInt(t.getAttribute("tooltip-delay"),10)||300,s=t.getAttribute("tooltip-disabled"),l=s?e.findContext(t):null,f=`nojs-tooltip-${++Ze}`,p=document.createElement("div");p.className="nojs-tooltip",p.setAttribute("role","tooltip"),p.setAttribute("id",f),p.setAttribute("aria-hidden","true"),p.textContent=o,t.setAttribute("aria-describedby",f),U.set(t,p);let m=()=>{if(s&&l&&e.evaluate(s,l))return;C.has(t)&&clearTimeout(C.get(t));let y=setTimeout(()=>{C.delete(t),!(s&&l&&e.evaluate(s,l))&&Qe(t,p,n)},d);C.set(t,y)},h=()=>{C.has(t)&&(clearTimeout(C.get(t)),C.delete(t)),Je(t,p)},a=()=>m(),c=()=>h(),u=()=>m(),b=()=>h(),g=y=>{y.key==="Escape"&&p.getAttribute("aria-hidden")==="false"&&h()};t.addEventListener("mouseenter",a),t.addEventListener("mouseleave",c),t.addEventListener("focusin",u),t.addEventListener("focusout",b),t.addEventListener("keydown",g),Ye(t,()=>{t.removeEventListener("mouseenter",a),t.removeEventListener("mouseleave",c),t.removeEventListener("focusin",u),t.removeEventListener("focusout",b),t.removeEventListener("keydown",g),C.has(t)&&(clearTimeout(C.get(t)),C.delete(t)),p.remove(),U.delete(t)})}})}function jt(e,t={}){Et(e)}function _t(){wt()}var k=new Map;function kt(){k.clear()}function Q(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let e=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-modal",""),t.textContent=e,document.head.appendChild(t)}function er(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var zt='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',pt=new WeakMap;function rr(e){let t=r=>{if(r.key!=="Tab")return;let i=[...e.querySelectorAll(zt)].filter(d=>d.offsetParent!==null);if(i.length===0){r.preventDefault();return}let o=i[0],n=i[i.length-1];r.shiftKey?document.activeElement===o&&(r.preventDefault(),n.focus()):document.activeElement===n&&(r.preventDefault(),o.focus())};e.addEventListener("keydown",t),pt.set(e,t)}function It(e){let t=pt.get(e);t&&(e.removeEventListener("keydown",t),pt.delete(e))}var K=new WeakMap;function Ft(e){e.directive("modal",{priority:10,init(r,i,o){R();let n=o||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${n}`,r.setAttribute("data-modal-id",n),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let d=r.querySelector("h1, h2, h3, h4, h5, h6");d&&(d.id||(d.id=`nojs-modal-heading-${n}`),r.setAttribute("aria-labelledby",d.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let l=r.getAttribute("modal-class"),f=r.getAttribute("modal-escape"),p=h=>{h.target===r&&s!=="false"&&f!=="false"&&O(r,n)};r.addEventListener("click",p),D.set(n,r);let m=h=>{if(h.newState==="open"){if(r.style.zIndex=String(Tt()),l&&l.split(/\s+/).filter(Boolean).forEach(a=>r.classList.add(a)),requestAnimationFrame(()=>{let a=r.querySelector(zt);a?a.focus():r.focus()}),rr(r),f!=="false"){let a=c=>{c.key==="Escape"&&(c.stopPropagation(),O(r,n))};r.addEventListener("keydown",a),K.set(r,a)}}else if(h.newState==="closed"){l&&l.split(/\s+/).filter(Boolean).forEach(u=>r.classList.remove(u)),It(r);let a=K.get(r);a&&(r.removeEventListener("keydown",a),K.delete(r));let c=L.findIndex(u=>u.id===n);if(c!==-1){let u=L[c];L.splice(c,1),u.triggerEl&&requestAnimationFrame(()=>{u.triggerEl.focus()})}}};r.addEventListener("toggle",m),er(r,()=>{r.removeEventListener("click",p),r.removeEventListener("toggle",m),It(r);let h=K.get(r);h&&(r.removeEventListener("keydown",h),K.delete(r)),D.delete(n);let a=L.findIndex(c=>c.id===n);a!==-1&&L.splice(a,1)})}});let t=r=>t.open(r);t.open=r=>{let i=D.get(r);if(!i)return!1;L.push({id:r,el:i,triggerEl:null});try{i.showPopover()}catch{return!1}return!0},t.close=r=>{let i=D.get(r);return i?(O(i,r),!0):!1},t.closeAll=()=>{for(let r=L.length-1;r>=0;r--)O(L[r].el,L[r].id)},e.modal=t}function O(e,t){try{e.hidePopover()}catch{}}function or(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Pt(e){e.directive("modal-open",{priority:10,init(t,r,i){R();let o=i;if(!o){let m=(t.closest("[use]")||t.parentElement)?.querySelector("[data-modal-id]");if(m&&(o=m.getAttribute("data-modal-id")),!o){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}t.setAttribute("aria-haspopup","dialog"),t.setAttribute("aria-expanded","false");let n=()=>{let p=D.get(o)||document.querySelector(`[data-modal-id="${o}"]`);if(!p){console.warn(`[modal-open] modal "${o}" not found`);return}L.push({id:o,el:p,triggerEl:t}),t.setAttribute("aria-expanded","true"),p.id&&t.setAttribute("aria-controls",p.id);try{p.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${o}"`)}},d=()=>{t.setAttribute("aria-expanded","false")},s=null,l=null;requestAnimationFrame(()=>{let p=D.get(o);p&&(l=p,s=m=>{m.newState==="closed"&&t.setAttribute("aria-expanded","false")},p.addEventListener("toggle",s))}),t.addEventListener("click",n),or(t,()=>{t.removeEventListener("click",n),l&&s&&l.removeEventListener("toggle",s)})}})}function nr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Mt(e){e.directive("modal-close",{priority:10,init(t,r,i){R();let o=()=>{let n,d;if(i){if(d=i,n=D.get(d),!n){console.warn(`[modal-close] modal "${d}" not found`);return}}else{if(n=t.closest("[modal]"),!n){console.warn("[modal-close] no parent modal found");return}d=n.getAttribute("modal")}O(n,d)};t.addEventListener("click",o),nr(t,()=>{t.removeEventListener("click",o)})}})}function qt(e,t={}){Ft(e),Pt(e),Mt(e)}function Bt(){Dt()}var P={openMenus:new Map};function Ht(){P.openMenus.clear()}function G(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let e=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-toast",""),t.textContent=e,document.head.appendChild(t)}function bt(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var cr=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function gt(){return I.size>0?I.values().next().value:dr("top-right")}function dr(e){if(I.has(e))return I.get(e);let t=document.createElement("div");return t.classList.add("nojs-toast-container"),t.setAttribute("data-position",e),t.setAttribute("role","log"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-relevant","additions"),document.body.appendChild(t),I.set(e,t),t}function lr(e){return e.startsWith("top")}function ht(e,t,r,i,o){let n=Kt(),d=e.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",n),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let l=document.createElement("span");if(l.textContent=t,s.appendChild(l),o){let f=document.createElement("button");f.type="button",f.classList.add("nojs-toast-dismiss"),f.setAttribute("aria-label","Dismiss"),f.textContent="\xD7",f.addEventListener("click",()=>J(s)),s.appendChild(f)}if(lr(d)&&e.firstChild?e.insertBefore(s,e.firstChild):e.appendChild(s),i>0){let f=setTimeout(()=>{N.delete(f),J(s)},i);N.add(f),s._toastTimerId=f}return s}function J(e){!e||!e.isConnected||(e._toastTimerId!=null&&(clearTimeout(e._toastTimerId),N.delete(e._toastTimerId)),e.remove())}function Zt(e){Xt(),e.directive("toast-container",{priority:10,init(r,i,o){let n=o&&cr.has(o)?o:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",n),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),I.set(n,r),bt(r,()=>{I.get(n)===r&&I.delete(n)})}}),e.directive("toast",{priority:10,init(r,i,o){if(!o)return;let n=r.getAttribute("toast-type")||"info",d=parseInt(r.getAttribute("toast-duration"),10)||3e3,s=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let a=()=>{let c=gt();ht(c,o,n,d,s)};r.addEventListener("click",a),bt(r,()=>r.removeEventListener("click",a));return}let f=e.findContext(r),p;function m(){let a=e.evaluate(o,f);if(a&&a!==p){let c=typeof a=="string"?a:String(a),u=gt();ht(u,c,n,d,s)}p=a}let h=f.$watch(m);bt(r,h)}});let t=(r,i="info",o=3e3)=>{if(typeof document>"u")return;let n=!0,d=gt();return ht(d,String(r),i,o,n)};t.dismiss=r=>{let i=document.querySelector(`[data-toast-id="${r}"]`);i&&J(i)},t.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>J(r))},e.toast=t}function Qt(e,t={}){Zt(e)}function Jt(){Yt()}var q={containers:new Map};function te(){q.containers.clear()}function ee(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let e=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-table",""),t.textContent=e,document.head.appendChild(t)}function Ar(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Er(e,t){let r=e.querySelector("tbody");if(!r)return null;let i=null;if(r.hasAttribute("each")||r.hasAttribute("foreach")?i=r:i=r.querySelector("[each]")||r.querySelector("[foreach]"),!i)return null;let o=i.getAttribute("each")||i.getAttribute("foreach");if(!o)return null;let n=o.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return n?{iteratorVar:n[1],arrayPath:n[2].trim()}:null}function jr(e,t){let r=t.split("."),i=e;for(let o of r){if(i==null)return;i=i[o]}return i}function Ie(e,t,r){let i=t.split("."),o=e;for(let n=0;n<i.length-1;n++){if(o[i[n]]==null)return;o=o[i[n]]}o[i[i.length-1]]=r}function ze(e,t){let r=Number.isNaN(e),i=Number.isNaN(t);return r&&i?0:r?1:i||e<t?-1:e>t?1:0}function Pe(e,t,r){if(e==null&&t==null)return 0;if(e==null)return-1;if(t==null)return 1;switch(r){case"number":return ze(Number(e),Number(t));case"date":return ze(new Date(e).getTime(),new Date(t).getTime());default:return String(e).localeCompare(String(t))}}function _r(e){let t=e.querySelectorAll("th[data-sortable]");for(let r of t)r.removeAttribute("data-sort-dir"),r.setAttribute("aria-sort","none")}function Me(e){e.directive("sortable",{priority:10,init(t){X(),t.classList.add("nojs-sortable")}})}function qe(e){e.directive("sort",{priority:11,init(t,r,i){X();let o=i;if(!o)return;let n=t.getAttribute("sort-type")||"string",d=t.getAttribute("sort-default");t.setAttribute("data-sortable",""),t.setAttribute("aria-sort","none");let s=t.closest("table");if(!s)return;M.sorts.has(s)||M.sorts.set(s,{column:null,direction:null}),(d==="asc"||d==="desc")&&(M.sorts.get(s).column||Fe(t,s,o,n,d,e));let l=()=>{let f=M.sorts.get(s),p;f.column!==o?p="asc":f.direction==="asc"?p="desc":f.direction==="desc"?p=null:p="asc",Fe(t,s,o,n,p,e)};t.addEventListener("click",l),Ar(t,()=>{t.removeEventListener("click",l),s&&!s.isConnected&&(M.sorts.delete(s),delete s._nojsOriginalOrder,delete s._nojsOriginalRows)})}})}function Fe(e,t,r,i,o,n){let d=M.sorts.get(t);_r(t),o?(e.setAttribute("data-sort-dir",o),e.setAttribute("aria-sort",o==="asc"?"ascending":"descending"),d.column=r,d.direction=o):(d.column=null,d.direction=null);let s=Er(t,n);if(s){let l=n.findContext(t),f=l?jr(l,s.arrayPath):null;if(Array.isArray(f)){if(!o){let m=t._nojsOriginalOrder;if(m){let h=new Set(f),a=m.filter(c=>h.has(c));for(let c of f)m.includes(c)||a.push(c);Ie(l,s.arrayPath,a)}return}t._nojsOriginalOrder||(t._nojsOriginalOrder=[...f]);let p=[...f].sort((m,h)=>{let a=m!=null?m[r]:null,c=h!=null?h[r]:null,u=Pe(a,c,i);return o==="desc"?-u:u});Ie(l,s.arrayPath,p);return}}kr(t,e,r,i,o)}function kr(e,t,r,i,o){let n=e.querySelector("tbody");if(!n)return;let l=[...t.closest("tr").children].indexOf(t);if(l<0)return;let f=[...n.querySelectorAll(":scope > tr")];if(e._nojsOriginalRows||(e._nojsOriginalRows=[...f]),!o){let h=document.createDocumentFragment();for(let a of e._nojsOriginalRows)h.appendChild(a);n.appendChild(h);return}let p=h=>{let a=h.replace(/[^0-9.\-]/g,"");return a===""||a==="-"?NaN:parseFloat(a)};f.sort((h,a)=>{let c=h.children[l]?.textContent?.trim()||"",u=a.children[l]?.textContent?.trim()||"",b=Pe(i==="number"?p(c):c,i==="number"?p(u):u,i);return o==="desc"?-b:b});let m=document.createDocumentFragment();for(let h of f)m.appendChild(h);n.appendChild(m)}function Be(e){e.directive("fixed-header",{priority:10,init(t){X(),t.classList.add("nojs-fixed-header")}})}function He(e){e.directive("fixed-col",{priority:10,init(t){X(),t.classList.add("nojs-fixed-col")}})}function $e(e,t={}){Me(e),qe(e),Be(e),He(e)}function Re(){De()}var Sr={name:"nojs-elements",install(e,t={}){jt(e,t),Lt(e,t),qt(e,t),Wt(e,t),Qt(e,t),se(e,t),me(e,t),ye(e,t),je(e,t),Ce(e,t),$e(e,t)},dispose(e){_t(),Ct(),Bt(),Vt(),Jt(),ae(),be(),xe(),Te(),Re()}},Lr=Sr;
