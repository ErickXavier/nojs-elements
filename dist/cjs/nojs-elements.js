 ...
 */
var Ze=Object.defineProperty;var xn=Object.getOwnPropertyDescriptor;var En=Object.getOwnPropertyNames;var wn=Object.prototype.hasOwnProperty;var An=(t,e)=>{for(var r in e)Ze(t,r,{get:e[r],enumerable:!0})},_n=(t,e,r,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of En(e))!wn.call(t,n)&&n!==r&&Ze(t,n,{get:()=>e[n],enumerable:!(o=xn(e,n))||o.enumerable});return t};var kn=t=>_n(Ze({},"__esModule",{value:!0}),t);var Co={};An(Co,{default:()=>jo});module.exports=kn(Co);var E={dragging:null,selected:new Map,placeholder:null},Fe=new Map;function ht(){E.dragging=null,E.selected.clear(),E.placeholder&&(E.placeholder.remove(),E.placeholder=null),Fe.clear()}function Pe(){if(typeof document>"u"||document.querySelector("style[data-nojs-dnd]"))return;let t=`
.nojs-dragging {
  opacity: 0.5;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tooltip",""),e.textContent=t,document.head.appendChild(e)}function $n(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var He=8;function qt(t,e,r){let o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),i=window.innerWidth,d=window.innerHeight,s,a;switch(r){case"bottom":s=o.bottom+He,a=o.left+(o.width-n.width)/2;break;case"left":s=o.top+(o.height-n.height)/2,a=o.left-n.width-He;break;case"right":s=o.top+(o.height-n.height)/2,a=o.right+He;break;default:s=o.top-n.height-He,a=o.left+(o.width-n.width)/2;break}a<4&&(a=4),a+n.width>i-4&&(a=i-n.width-4),s<4&&(s=4),s+n.height>d-4&&(s=d-n.height-4),t.style.top=`${s}px`,t.style.left=`${a}px`}var Rn=0;function qn(t,e,r){document.body.appendChild(e),qt(e,t,r),e.setAttribute("aria-hidden","false")}function Rt(t,e){e.setAttribute("aria-hidden","true"),e.remove()}function zn(t,e){t&&typeof t._warn=="function"?t._warn(e):console.warn(e)}function zt(t){t.directive("tooltip",{priority:20,init(e,r,o){$t();let n=o;if(!n){zn(t,"[tooltip] attribute value (tooltip text) is required.");return}let i=e.getAttribute("tooltip-position")||"top",d=parseInt(e.getAttribute("tooltip-delay"),10),s=Number.isNaN(d)?300:d,a=e.getAttribute("tooltip-disabled"),c=a?t.findContext(e):null,f=()=>{if(!a||!c)return!1;try{return!!t.evaluate(a,c)}catch{return!1}},l=`nojs-tooltip-${++Rn}`,m=document.createElement("div");m.className="nojs-tooltip",m.setAttribute("role","tooltip"),m.setAttribute("id",l),m.setAttribute("aria-hidden","true"),m.textContent=n,e.setAttribute("aria-describedby",l),ve.set(e,m);let p=!1,g=0,v=()=>{!p||!e.isConnected||g||(g=requestAnimationFrame(()=>{g=0,!(!p||!e.isConnected)&&qt(m,e,i)}))},y=()=>{window.addEventListener("scroll",v,!0),window.addEventListener("resize",v)},u=()=>{window.removeEventListener("scroll",v,!0),window.removeEventListener("resize",v),g&&(cancelAnimationFrame(g),g=0)},b=()=>{p||(qn(e,m,i),p=!0,y())},A=()=>{if(!p){Rt(e,m);return}u(),Rt(e,m),p=!1},h=()=>{if(f())return;te.has(e)&&clearTimeout(te.get(e));let B=setTimeout(()=>{te.delete(e),!f()&&e.isConnected&&b()},s);te.set(e,B)},x=()=>{te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),A()},_=()=>h(),k=()=>x(),j=()=>h(),L=()=>x(),S=B=>{B.key==="Escape"&&m.getAttribute("aria-hidden")==="false"&&x()};e.addEventListener("mouseenter",_),e.addEventListener("mouseleave",k),e.addEventListener("focusin",j),e.addEventListener("focusout",L),e.addEventListener("keydown",S);let w=null;if(a&&c&&typeof c.$watch=="function"){let B=()=>{p&&f()&&A()};w=c.$watch(B)}$n(e,()=>{e.removeEventListener("mouseenter",_),e.removeEventListener("mouseleave",k),e.removeEventListener("focusin",j),e.removeEventListener("focusout",L),e.removeEventListener("keydown",S),w&&(w(),w=null),u(),te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),p=!1,m.remove(),ve.delete(e)})}})}function Mt(t,e={}){zt(t)}function Ht(){Pt()}var K=new Map;function Ot(){K.clear()}function Oe(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let t=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-modal",""),e.textContent=t,document.head.appendChild(e)}function Hn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Xt='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',nt=new WeakMap;function On(t){let e=r=>{if(r.key!=="Tab")return;let o=[...t.querySelectorAll(Xt)].filter(d=>d.offsetParent!==null);if(o.length===0){r.preventDefault();return}let n=o[0],i=o[o.length-1];r.shiftKey?document.activeElement===n&&(r.preventDefault(),i.focus()):document.activeElement===i&&(r.preventDefault(),n.focus())};t.addEventListener("keydown",e),nt.set(t,e)}function Kt(t){let e=nt.get(t);e&&(t.removeEventListener("keydown",e),nt.delete(t))}var je=new WeakMap;function Zt(t){t.directive("modal",{priority:10,init(r,o,n){xe();let i=n||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${i}`,r.setAttribute("data-modal-id",i),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let d=r.querySelector("h1, h2, h3, h4, h5, h6");d&&(d.id||(d.id=`nojs-modal-heading-${i}`),r.setAttribute("aria-labelledby",d.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let a=r.getAttribute("modal-class"),c=r.getAttribute("modal-escape"),f=m=>{m.target===r&&s!=="false"&&c!=="false"&&Ee(r,i)};r.addEventListener("click",f),oe.set(i,r);let l=m=>{if(m.newState==="open"){if(r.style.zIndex=String(Ut()),a&&a.split(/\s+/).filter(Boolean).forEach(p=>r.classList.add(p)),requestAnimationFrame(()=>{if(!r.isConnected||!W.some(g=>g.el===r))return;let p=r.querySelector(Xt);p?p.focus():r.focus()}),On(r),c!=="false"){let p=g=>{g.key==="Escape"&&(g.stopPropagation(),Ee(r,i))};r.addEventListener("keydown",p),je.set(r,p)}}else if(m.newState==="closed"){a&&a.split(/\s+/).filter(Boolean).forEach(v=>r.classList.remove(v)),Kt(r);let p=je.get(r);p&&(r.removeEventListener("keydown",p),je.delete(r));let g=W.findIndex(v=>v.el===r);if(g===-1&&(g=W.findIndex(v=>v.id===i)),g!==-1){let v=W[g];W.splice(g,1),v.triggerEl&&requestAnimationFrame(()=>{v.triggerEl.focus()})}}};r.addEventListener("toggle",l),Hn(r,()=>{r.removeEventListener("click",f),r.removeEventListener("toggle",l),Kt(r);let m=je.get(r);m&&(r.removeEventListener("keydown",m),je.delete(r)),oe.delete(i);let p=W.findIndex(g=>g.el===r);p===-1&&(p=W.findIndex(g=>g.id===i)),p!==-1&&W.splice(p,1)})}});let e=r=>e.open(r);e.open=r=>{let o=oe.get(r);if(!o)return!1;try{o.showPopover()}catch{return!1}return W.some(n=>n.id===r)||W.push({id:r,el:o,triggerEl:null}),!0},e.close=r=>{let o=oe.get(r);return o?(Ee(o,r),!0):!1},e.closeAll=()=>{for(let r=W.length-1;r>=0;r--)Ee(W[r].el,W[r].id)},t.modal=e}function Ee(t,e){try{t.hidePopover()}catch{}}function Qt(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Vn(t){let e=document.querySelectorAll("[data-modal-id]");for(let r of e)if(r.getAttribute("data-modal-id")===t)return r;return null}function Nt(t){t.directive("modal-open",{priority:10,init(e,r,o){xe();let n=o;if(!n){let l=(e.closest("[use]")||e.parentElement)?.querySelector("[data-modal-id]");if(l&&(n=l.getAttribute("data-modal-id")),!n){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}e.setAttribute("aria-haspopup","dialog"),e.setAttribute("aria-expanded","false");let i=()=>{let f=oe.get(n)||Vn(n);if(!f){console.warn(`[modal-open] modal "${n}" not found`);return}let l=W.some(m=>m.id===n);f.id&&e.setAttribute("aria-controls",f.id);try{f.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${n}"`);return}l||W.push({id:n,el:f,triggerEl:e}),e.setAttribute("aria-expanded","true")},d=()=>{e.setAttribute("aria-expanded","false")},s=null,a=null,c=()=>{let f=oe.get(n);return f?(a=f,s=l=>{l.newState==="closed"&&e.setAttribute("aria-expanded","false")},f.addEventListener("toggle",s),!0):!1};if(!c()){let f=requestAnimationFrame(c);Qt(e,()=>cancelAnimationFrame(f))}e.addEventListener("click",i),Qt(e,()=>{e.removeEventListener("click",i),a&&s&&a.removeEventListener("toggle",s)})}})}function Wn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Jt(t){t.directive("modal-close",{priority:10,init(e,r,o){xe();let n=()=>{let i,d;if(o){if(d=o,i=oe.get(d),!i){console.warn(`[modal-close] modal "${d}" not found`);return}}else{if(i=e.closest("[modal]"),!i){console.warn("[modal-close] no parent modal found");return}d=i.getAttribute("modal")}Ee(i,d)};e.addEventListener("click",n),Wn(e,()=>{e.removeEventListener("click",n)})}})}function er(t,e={}){Zt(t),Nt(t),Jt(t)}function tr(){Yt()}var ce={openMenus:new Map};function rr(){ce.openMenus.clear()}function we(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let t=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-dropdown",""),e.textContent=t,document.head.appendChild(e)}var Gn=0;function Un(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function nr(t,e,r){let o=r.getAttribute("dropdown-position")||"bottom",n=r.getAttribute("dropdown-align")||"start";t.style.top="",t.style.left="";let i=e.getBoundingClientRect(),d=t.getBoundingClientRect(),s=window.innerHeight,a=window.innerWidth,c,f;switch(o){case"top":c=i.top-d.height,f=i.left;break;case"left":c=i.top,f=i.left-d.width;break;case"right":c=i.top,f=i.right;break;default:c=i.bottom,f=i.left}o==="bottom"||o==="top"?n==="end"&&(f=i.right-d.width):n==="end"&&(c=i.bottom-d.height),o==="bottom"&&c+d.height>s&&i.top-d.height>0?c=i.top-d.height:o==="top"&&c<0&&i.bottom+d.height<=s&&(c=i.bottom),f<4&&(f=4),f+d.width>a-4&&(f=a-d.width-4),t.style.top=`${c}px`,t.style.left=`${f}px`}function it(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function ot(t){let e=it(t);e.length&&e[0].focus()}function or(t){let e=it(t);e.length&&e[e.length-1].focus()}function ir(t){t.directive("dropdown",{priority:15,init(r){we()}}),t.directive("dropdown-toggle",{priority:15,init(r){we();let o=r.closest("[dropdown]");if(!o)return;let n=o.querySelector("[dropdown-menu]");if(!n)return;r.setAttribute("aria-haspopup","menu"),r.setAttribute("aria-expanded","false"),n.classList.add("nojs-dropdown-menu"),n.setAttribute("role","menu"),n.setAttribute("popover","auto"),n.id||(n.id=`nojs-dd-menu-${Date.now()}-${Gn++}`),r.setAttribute("aria-controls",n.id);let i=!1,d=typeof n.showPopover=="function"&&typeof n.hidePopover=="function";function s(){if(n.setAttribute("data-open",""),d&&!i)try{n.showPopover(),i=!0}catch{i=!1}r.setAttribute("aria-expanded","true"),nr(n,r,o),ce.openMenus.set(n,{toggle:r,wrapper:o})}function a(){if(d&&i){i=!1;try{n.hidePopover()}catch{}}n.removeAttribute("data-open"),r.setAttribute("aria-expanded","false"),ce.openMenus.delete(n)}function c(){return r.getAttribute("aria-expanded")==="true"}let f=u=>{u.newState==="closed"&&c()&&a()};n.addEventListener("toggle",f);let l=u=>{u.preventDefault(),u.stopPropagation(),c()?a():s()};r.addEventListener("click",l);let m=u=>{c()&&!o.contains(u.target)&&a()};document.addEventListener("click",m,!0);let p=u=>{u.key==="Escape"&&c()&&(a(),r.focus())};document.addEventListener("keydown",p);let g=u=>{switch(u.key){case"Enter":case" ":u.preventDefault(),s(),ot(n);break;case"ArrowDown":u.preventDefault(),s(),ot(n);break;case"ArrowUp":u.preventDefault(),s(),or(n);break}};r.addEventListener("keydown",g);let v=u=>{if(!(!c()||it(n).find(h=>h===document.activeElement)))switch(u.key){case"ArrowDown":u.preventDefault(),ot(n);break;case"ArrowUp":u.preventDefault(),or(n);break}};n.addEventListener("keydown",v);let y=()=>{c()&&nr(n,r,o)};window.addEventListener("scroll",y,!0),window.addEventListener("resize",y),Un(r,()=>{r.removeEventListener("click",l),r.removeEventListener("keydown",g),n.removeEventListener("keydown",v),n.removeEventListener("toggle",f),document.removeEventListener("click",m,!0),document.removeEventListener("keydown",p),window.removeEventListener("scroll",y,!0),window.removeEventListener("resize",y),ce.openMenus.delete(n)})}}),t.directive("dropdown-menu",{priority:15,init(r){we(),r.hasAttribute("role")||r.setAttribute("role","menu")}});let e=r=>e.open(r);e.open=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")==="true"?!1:(i.click(),!0)},e.close=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")!=="true"?!1:(i.click(),!0)},t.dropdown=e}function sr(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Yn(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function st(t,e){if(!t)return;if(typeof t.hidePopover=="function")try{t.hidePopover()}catch{}t.removeAttribute("data-open");let r=e&&e.querySelector("[dropdown-toggle]");r&&r.setAttribute("aria-expanded","false"),ce.openMenus.has(t)&&ce.openMenus.delete(t)}function ar(t){t.directive("dropdown-item",{priority:15,init(e){we();let r=e.closest("[dropdown-menu]"),o=e.closest("[dropdown]");e.setAttribute("role","menuitem"),e.setAttribute("tabindex","-1"),e.classList.add("nojs-dropdown-item"),e.hasAttribute("disabled")&&e.setAttribute("aria-disabled","true");let n=d=>{if(!r)return;let s=Yn(r),a=s.indexOf(e);switch(d.key){case"ArrowDown":{d.preventDefault(),(a+1<s.length?s[a+1]:s[0]).focus();break}case"ArrowUp":{d.preventDefault(),(a-1>=0?s[a-1]:s[s.length-1]).focus();break}case"Home":{d.preventDefault(),s.length&&s[0].focus();break}case"End":{d.preventDefault(),s.length&&s[s.length-1].focus();break}case"Enter":{d.preventDefault(),e.click();break}case"Escape":{if(d.preventDefault(),st(r,o),o){let c=o.querySelector("[dropdown-toggle]");c&&c.focus()}break}case"Tab":{st(r,o);break}}};e.addEventListener("keydown",n),sr(e,()=>e.removeEventListener("keydown",n));let i=()=>{if(st(r,o),o){let d=o.querySelector("[dropdown-toggle]");d&&d.focus()}};e.addEventListener("click",i),sr(e,()=>e.removeEventListener("click",i))}})}function dr(t,e={}){ir(t),ar(t)}function cr(){rr()}var ie=new Map,Ae=new Set,lr=0;function ur(){return++lr}function pr(){for(let t of Ae)clearTimeout(t);Ae.clear();for(let t of ie.values())t.remove();ie.clear(),lr=0}function fr(){if(typeof document>"u"||document.querySelector("style[data-nojs-toast]"))return;let t=`
