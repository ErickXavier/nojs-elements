 ...
 * @license MIT
 */
var Y=new Map,T=new Map;function At(){for(let e of T.values())clearTimeout(e);T.clear();for(let e of Y.values())e.remove();Y.clear()}function Et(){if(typeof document>"u"||document.querySelector("style[data-nojs-tooltip]"))return;let e=`
.nojs-tooltip {
  position: fixed;
  z-index: 9999;
  pointer-events: none;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tooltip",""),t.textContent=e,document.head.appendChild(t)}function Ge(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var J=8;function We(e,t,r){let i=t.getBoundingClientRect(),o=e.getBoundingClientRect(),n=window.innerWidth,d=window.innerHeight,s,l;switch(r){case"bottom":s=i.bottom+J,l=i.left+(i.width-o.width)/2;break;case"left":s=i.top+(i.height-o.height)/2,l=i.left-o.width-J;break;case"right":s=i.top+(i.height-o.height)/2,l=i.right+J;break;default:s=i.top-o.height-J,l=i.left+(i.width-o.width)/2;break}l<4&&(l=4),l+o.width>n-4&&(l=n-o.width-4),s<4&&(s=4),s+o.height>d-4&&(s=d-o.height-4),e.style.top=`${s}px`,e.style.left=`${l}px`}var Ve=0;function Ke(e,t,r){document.body.appendChild(t),We(t,e,r),t.setAttribute("aria-hidden","false")}function Ue(e,t){t.setAttribute("aria-hidden","true"),t.remove()}function jt(e){e.directive("tooltip",{priority:20,init(t,r,i){Et();let o=i;if(!o){console.warn("[tooltip] attribute value (tooltip text) is required.");return}let n=t.getAttribute("tooltip-position")||"top",d=parseInt(t.getAttribute("tooltip-delay"),10)||300,s=t.getAttribute("tooltip-disabled"),l=s?e.findContext(t):null,f=`nojs-tooltip-${++Ve}`,p=document.createElement("div");p.className="nojs-tooltip",p.setAttribute("role","tooltip"),p.setAttribute("id",f),p.setAttribute("aria-hidden","true"),p.textContent=o,t.setAttribute("aria-describedby",f),Y.set(t,p);let m=()=>{if(s&&l&&e.evaluate(s,l))return;T.has(t)&&clearTimeout(T.get(t));let y=setTimeout(()=>{T.delete(t),!(s&&l&&e.evaluate(s,l))&&Ke(t,p,n)},d);T.set(t,y)},h=()=>{T.has(t)&&(clearTimeout(T.get(t)),T.delete(t)),Ue(t,p)},c=()=>m(),a=()=>h(),u=()=>m(),b=()=>h(),g=y=>{y.key==="Escape"&&p.getAttribute("aria-hidden")==="false"&&h()};t.addEventListener("mouseenter",c),t.addEventListener("mouseleave",a),t.addEventListener("focusin",u),t.addEventListener("focusout",b),t.addEventListener("keydown",g),Ge(t,()=>{t.removeEventListener("mouseenter",c),t.removeEventListener("mouseleave",a),t.removeEventListener("focusin",u),t.removeEventListener("focusout",b),t.removeEventListener("keydown",g),T.has(t)&&(clearTimeout(T.get(t)),T.delete(t)),p.remove(),Y.delete(t)})}})}function kt(e,t={}){jt(e)}function _t(){At()}var S=new Map;function St(){S.clear()}function tt(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let e=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-modal",""),t.textContent=e,document.head.appendChild(t)}function Xe(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var Ft='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',pt=new WeakMap;function Ne(e){let t=r=>{if(r.key!=="Tab")return;let i=[...e.querySelectorAll(Ft)].filter(d=>d.offsetParent!==null);if(i.length===0){r.preventDefault();return}let o=i[0],n=i[i.length-1];r.shiftKey?document.activeElement===o&&(r.preventDefault(),n.focus()):document.activeElement===n&&(r.preventDefault(),o.focus())};e.addEventListener("keydown",t),pt.set(e,t)}function zt(e){let t=pt.get(e);t&&(e.removeEventListener("keydown",t),pt.delete(e))}var X=new WeakMap;function Pt(e){e.directive("modal",{priority:10,init(r,i,o){G();let n=o||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${n}`,r.setAttribute("data-modal-id",n),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let d=r.querySelector("h1, h2, h3, h4, h5, h6");d&&(d.id||(d.id=`nojs-modal-heading-${n}`),r.setAttribute("aria-labelledby",d.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let l=r.getAttribute("modal-class"),f=r.getAttribute("modal-escape"),p=h=>{h.target===r&&s!=="false"&&f!=="false"&&W(r,n)};r.addEventListener("click",p),I.set(n,r);let m=h=>{if(h.newState==="open"){if(r.style.zIndex=String(Dt()),l&&l.split(/\s+/).filter(Boolean).forEach(c=>r.classList.add(c)),requestAnimationFrame(()=>{let c=r.querySelector(Ft);c?c.focus():r.focus()}),Ne(r),f!=="false"){let c=a=>{a.key==="Escape"&&(a.stopPropagation(),W(r,n))};r.addEventListener("keydown",c),X.set(r,c)}}else if(h.newState==="closed"){l&&l.split(/\s+/).filter(Boolean).forEach(u=>r.classList.remove(u)),zt(r);let c=X.get(r);c&&(r.removeEventListener("keydown",c),X.delete(r));let a=C.findIndex(u=>u.id===n);if(a!==-1){let u=C[a];C.splice(a,1),u.triggerEl&&requestAnimationFrame(()=>{u.triggerEl.focus()})}}};r.addEventListener("toggle",m),Xe(r,()=>{r.removeEventListener("click",p),r.removeEventListener("toggle",m),zt(r);let h=X.get(r);h&&(r.removeEventListener("keydown",h),X.delete(r)),I.delete(n);let c=C.findIndex(a=>a.id===n);c!==-1&&C.splice(c,1)})}});let t=r=>t.open(r);t.open=r=>{let i=I.get(r);if(!i)return!1;C.push({id:r,el:i,triggerEl:null});try{i.showPopover()}catch{return!1}return!0},t.close=r=>{let i=I.get(r);return i?(W(i,r),!0):!1},t.closeAll=()=>{for(let r=C.length-1;r>=0;r--)W(C[r].el,C[r].id)},e.modal=t}function W(e,t){try{e.hidePopover()}catch{}}function Ze(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Mt(e){e.directive("modal-open",{priority:10,init(t,r,i){G();let o=i;if(!o){let m=(t.closest("[use]")||t.parentElement)?.querySelector("[data-modal-id]");if(m&&(o=m.getAttribute("data-modal-id")),!o){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}t.setAttribute("aria-haspopup","dialog"),t.setAttribute("aria-expanded","false");let n=()=>{let p=I.get(o)||document.querySelector(`[data-modal-id="${o}"]`);if(!p){console.warn(`[modal-open] modal "${o}" not found`);return}C.push({id:o,el:p,triggerEl:t}),t.setAttribute("aria-expanded","true"),p.id&&t.setAttribute("aria-controls",p.id);try{p.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${o}"`)}},d=()=>{t.setAttribute("aria-expanded","false")},s=null,l=null;requestAnimationFrame(()=>{let p=I.get(o);p&&(l=p,s=m=>{m.newState==="closed"&&t.setAttribute("aria-expanded","false")},p.addEventListener("toggle",s))}),t.addEventListener("click",n),Ze(t,()=>{t.removeEventListener("click",n),l&&s&&l.removeEventListener("toggle",s)})}})}function Qe(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function qt(e){e.directive("modal-close",{priority:10,init(t,r,i){G();let o=()=>{let n,d;if(i){if(d=i,n=I.get(d),!n){console.warn(`[modal-close] modal "${d}" not found`);return}}else{if(n=t.closest("[modal]"),!n){console.warn("[modal-close] no parent modal found");return}d=n.getAttribute("modal")}W(n,d)};t.addEventListener("click",o),Qe(t,()=>{t.removeEventListener("click",o)})}})}function Bt(e,t={}){Pt(e),Mt(e),qt(e)}function Ht(){It()}var M={openMenus:new Map};function $t(){M.openMenus.clear()}function V(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let e=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-toast",""),t.textContent=e,document.head.appendChild(t)}function bt(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var rr=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function gt(){return z.size>0?z.values().next().value:or("top-right")}function or(e){if(z.has(e))return z.get(e);let t=document.createElement("div");return t.classList.add("nojs-toast-container"),t.setAttribute("data-position",e),t.setAttribute("role","log"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-relevant","additions"),document.body.appendChild(t),z.set(e,t),t}function nr(e){return e.startsWith("top")}function ht(e,t,r,i,o){let n=Xt(),d=e.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",n),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let l=document.createElement("span");if(l.textContent=t,s.appendChild(l),o){let f=document.createElement("button");f.type="button",f.classList.add("nojs-toast-dismiss"),f.setAttribute("aria-label","Dismiss"),f.textContent="\xD7",f.addEventListener("click",()=>et(s)),s.appendChild(f)}if(nr(d)&&e.firstChild?e.insertBefore(s,e.firstChild):e.appendChild(s),i>0){let f=setTimeout(()=>{K.delete(f),et(s)},i);K.add(f),s._toastTimerId=f}return s}function et(e){!e||!e.isConnected||(e._toastTimerId!=null&&(clearTimeout(e._toastTimerId),K.delete(e._toastTimerId)),e.remove())}function Qt(e){Zt(),e.directive("toast-container",{priority:10,init(r,i,o){let n=o&&rr.has(o)?o:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",n),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),z.set(n,r),bt(r,()=>{z.get(n)===r&&z.delete(n)})}}),e.directive("toast",{priority:10,init(r,i,o){if(!o)return;let n=r.getAttribute("toast-type")||"info",d=parseInt(r.getAttribute("toast-duration"),10)||3e3,s=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let c=()=>{let a=gt();ht(a,o,n,d,s)};r.addEventListener("click",c),bt(r,()=>r.removeEventListener("click",c));return}let f=e.findContext(r),p;function m(){let c=e.evaluate(o,f);if(c&&c!==p){let a=typeof c=="string"?c:String(c),u=gt();ht(u,a,n,d,s)}p=c}let h=f.$watch(m);bt(r,h)}});let t=(r,i="info",o=3e3)=>{if(typeof document>"u")return;let n=!0,d=gt();return ht(d,String(r),i,o,n)};t.dismiss=r=>{let i=document.querySelector(`[data-toast-id="${r}"]`);i&&et(i)},t.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>et(r))},e.toast=t}function Jt(e,t={}){Qt(e)}function te(){Nt()}var q={containers:new Map};function ee(){q.containers.clear()}function re(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let e=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tabs",""),t.textContent=e,document.head.appendChild(t)}function ir(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var sr=0;function oe(e){return`${e}-${++sr}`}function vt(e,t){let r=q.containers.get(e);if(!r)return;let{tabs:i,panels:o}=r;if(!(t<0||t>=i.length)&&i[t].getAttribute("aria-disabled")!=="true"){for(let n=0;n<i.length;n++)i[n].setAttribute("aria-selected","false"),i[n].setAttribute("tabindex","-1"),o[n].setAttribute("aria-hidden","true"),o[n].inert=!0;i[t].setAttribute("aria-selected","true"),i[t].setAttribute("tabindex","0"),o[t].setAttribute("aria-hidden","false"),o[t].inert=!1,r.activeIndex=t}}function N(e,t,r){let i=e.length,o=t;for(let n=0;n<i;n++)if(o=(o+r+i)%i,e[o].getAttribute("aria-disabled")!=="true")return o;return t}function ne(e){e.directive("tabs",{priority:10,init(t,r,i){re();let o=[],n=[];for(let a of Array.from(t.children))a.hasAttribute("tab")?o.push(a):a.hasAttribute("panel")&&n.push(a);if(o.length===0){console.warn("[tabs] No child [tab] elements found.");return}o.length!==n.length&&console.warn("[tabs] Mismatch: "+o.length+" tabs but "+n.length+" panels.");let d=t.getAttribute("tab-position")||"top";t.setAttribute("data-position",d),t.classList.add("nojs-tabs");let s=document.createElement("div");s.setAttribute("role","tablist"),s.classList.add("nojs-tablist");let l=Math.min(o.length,n.length);for(let a=0;a<l;a++){let u=o[a],b=n[a],g=u.id||oe("nojs-tab"),y=b.id||oe("nojs-panel");u.id=g,b.id=y,u.setAttribute("role","tab"),u.setAttribute("aria-selected","false"),u.setAttribute("aria-controls",y),u.setAttribute("tabindex","-1"),u.classList.add("nojs-tab"),b.setAttribute("role","tabpanel"),b.setAttribute("aria-labelledby",g),b.setAttribute("tabindex","0"),b.setAttribute("aria-hidden","true"),b.inert=!0,b.classList.add("nojs-panel"),s.appendChild(u)}let f=n[0];f?t.insertBefore(s,f):t.appendChild(s),q.containers.set(t,{tabs:o.slice(0,l),panels:n.slice(0,l),activeIndex:-1});let p=e.findContext(t);for(let a=0;a<l;a++){let u=o[a].getAttribute("tab-disabled");u&&e.evaluate(u,p)&&o[a].setAttribute("aria-disabled","true")}let m=0;if(i&&i.trim()!==""){let a=parseInt(i,10);!isNaN(a)&&a>=0&&a<l&&(m=a)}o[m]?.getAttribute("aria-disabled")==="true"&&(m=N(o.slice(0,l),m,1)),vt(t,m);let h=a=>{let u=q.containers.get(t);if(!u)return;let b=a.target;if(b.getAttribute("role")!=="tab")return;let{tabs:g}=u,y=g.indexOf(b);if(y===-1)return;let w=-1;switch(a.key){case"ArrowRight":case"ArrowDown":w=N(g,y,1);break;case"ArrowLeft":case"ArrowUp":w=N(g,y,-1);break;case"Home":w=N(g,g.length-1,1);break;case"End":w=N(g,0,-1);break;case"Tab":return;default:return}w!==-1&&w!==y&&(a.preventDefault(),vt(t,w),g[w].focus())};s.addEventListener("keydown",h);let c=a=>{let u=a.target.closest("[role='tab']");if(!u)return;let b=q.containers.get(t);if(!b)return;let g=b.tabs.indexOf(u);g!==-1&&(vt(t,g),u.focus())};s.addEventListener("click",c),ir(t,()=>{s.removeEventListener("keydown",h),s.removeEventListener("click",c),q.containers.delete(t)})}})}function ie(e){e.directive("tab",{priority:11,init(){}}),e.directive("tab-disabled",{priority:11,init(){}}),e.directive("tab-position",{priority:11,init(){}})}function se(e){e.directive("panel",{priority:11,init(){}})}function ae(e,t={}){ne(e),ie(e),se(e)}function ce(){ee()}var A={branches:new Map,selectedItem:null,typeahead:"",typeaheadTimer:null};function de(){A.branches.clear(),A.selectedItem=null,A.typeahead="",A.typeaheadTimer&&(clearTimeout(A.typeaheadTimer),A.typeaheadTimer=null)}function rt(){if(typeof document>"u"||document.querySelector("style[data-nojs-tree]"))return;let e=`
.nojs-tree {
  list-style: none;
  padding-left: 0;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tree",""),t.textContent=e,document.head.appendChild(t)}function yt(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function le(e){let t=[],r=document.createTreeWalker(e,NodeFilter.SHOW_ELEMENT,{acceptNode(o){return o.matches&&o.matches('.nojs-subtree[aria-hidden="true"]')?NodeFilter.FILTER_REJECT:o.getAttribute("role")==="treeitem"?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}}),i;for(;i=r.nextNode();)t.push(i);return t}function pe(e){return e.closest('[role="tree"]')}function ar(e){let t=e.cloneNode(!0);return t.querySelectorAll('[role="group"]').forEach(i=>i.remove()),(t.textContent||"").trim().toLowerCase()}function ue(e){e.directive("tree",{priority:15,init(t){rt(),t.classList.add("nojs-tree"),t.setAttribute("role","tree"),t.getAttribute("tree-icon")==="false"&&t.setAttribute("data-tree-icon","false")}})}function fe(e){e.directive("branch",{priority:16,init(t,r,i){rt();let o=i==="expanded";t.classList.add("nojs-branch"),t.setAttribute("role","treeitem"),t.setAttribute("aria-expanded",String(o));let n=pe(t);if(n){let c=n.querySelector('[role="treeitem"]');t.setAttribute("tabindex",c===t?"0":"-1")}else t.setAttribute("tabindex","0");let d=!1;queueMicrotask(()=>{if(d)return;let c=t.querySelector(":scope > [subtree], :scope > .nojs-subtree")||(t.nextElementSibling?.matches?.("[subtree], .nojs-subtree")?t.nextElementSibling:null);c?(A.branches.set(t,{expanded:o,subtreeEl:c}),c.setAttribute("aria-hidden",String(!o))):A.branches.set(t,{expanded:o,subtreeEl:null})});function s(c){let a=A.selectedItem;a&&a!==c&&(a.classList.remove("nojs-branch-selected"),a.setAttribute("aria-selected","false")),c.classList.add("nojs-branch-selected"),c.setAttribute("aria-selected","true"),A.selectedItem=c}function l(c){let a=A.branches.get(c);!a||!a.subtreeEl||(a.expanded=!a.expanded,c.setAttribute("aria-expanded",String(a.expanded)),a.subtreeEl.setAttribute("aria-hidden",String(!a.expanded)))}function f(c){let a=A.branches.get(c);!a||!a.subtreeEl||a.expanded||(a.expanded=!0,c.setAttribute("aria-expanded","true"),a.subtreeEl.setAttribute("aria-hidden","false"))}function p(c){let a=A.branches.get(c);!a||!a.subtreeEl||!a.expanded||(a.expanded=!1,c.setAttribute("aria-expanded","false"),a.subtreeEl.setAttribute("aria-hidden","true"))}let m=c=>{c.target!==t&&!t.contains(c.target)||(c.stopPropagation(),s(t),l(t))};t.addEventListener("click",m),yt(t,()=>t.removeEventListener("click",m));let h=c=>{let a=pe(t);if(!a)return;let u=le(a),b=u.indexOf(t),g=A.branches.get(t),y=g&&g.subtreeEl;switch(c.key){case"ArrowRight":if(c.preventDefault(),y&&!g.expanded)f(t);else if(y&&g.expanded){let w=g.subtreeEl.querySelector('[role="treeitem"]');w&&B(w,u)}break;case"ArrowLeft":if(c.preventDefault(),y&&g.expanded)p(t);else{let w=t.parentElement?.closest('[role="treeitem"]');w&&B(w,le(a))}break;case"ArrowDown":c.preventDefault(),b<u.length-1&&B(u[b+1],u);break;case"ArrowUp":c.preventDefault(),b>0&&B(u[b-1],u);break;case"Enter":case" ":c.preventDefault(),s(t),l(t);break;case"Home":c.preventDefault(),u.length>0&&B(u[0],u);break;case"End":c.preventDefault(),u.length>0&&B(u[u.length-1],u);break;default:if(c.key.length===1&&!c.ctrlKey&&!c.altKey&&!c.metaKey){c.preventDefault(),A.typeahead+=c.key.toLowerCase(),A.typeaheadTimer&&clearTimeout(A.typeaheadTimer),A.typeaheadTimer=setTimeout(()=>{A.typeahead="",A.typeaheadTimer=null},500);let w=b+1;for(let D=0;D<u.length;D++){let F=(w+D)%u.length;if(ar(u[F]).startsWith(A.typeahead)){B(u[F],u);break}}}break}};t.addEventListener("keydown",h),yt(t,()=>t.removeEventListener("keydown",h)),yt(t,()=>{d=!0,A.branches.delete(t),A.selectedItem===t&&(A.selectedItem=null)})}})}function B(e,t){for(let r of t)r.setAttribute("tabindex",r===e?"0":"-1");e.focus()}function me(e){e.directive("subtree",{priority:16,init(t){rt(),t.classList.add("nojs-subtree"),t.classList.add("nojs-tree"),t.setAttribute("role","group");for(let i of t.children)i.tagName==="LI"&&!i.querySelector("[branch], .nojs-branch")&&(i.setAttribute("role","treeitem"),i.setAttribute("tabindex","-1"),i.classList.add("nojs-tree-leaf"));let r=t.parentElement?.matches?.('[role="treeitem"]')?t.parentElement:t.previousElementSibling?.matches?.('[role="treeitem"]')?t.previousElementSibling:null;if(r){let i=A.branches.get(r);i?(t.setAttribute("aria-hidden",String(!i.expanded)),i.subtreeEl=t):t.setAttribute("aria-hidden","true")}else t.setAttribute("aria-hidden","true")}})}function be(e,t={}){ue(e),fe(e),me(e)}function ge(){de()}var ot=new Map;function he(){ot.clear()}function nt(){if(typeof document>"u"||document.querySelector("style[data-nojs-stepper]"))return;let e=`
