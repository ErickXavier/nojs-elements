...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-toast",""),t.textContent=e,document.head.appendChild(t)}var wr=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function zt(){return Z.size>0?Z.values().next().value:jr("top-right")}function jr(e){if(Z.has(e))return Z.get(e);let t=document.createElement("div");return t.classList.add("nojs-toast-container"),t.setAttribute("data-position",e),t.setAttribute("role","log"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-relevant","additions"),document.body.appendChild(t),Z.set(e,t),t}function kr(e){return e.startsWith("top")}function Ft(e,t,r,i,n){let o=Ee(),d=e.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",o),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let c=document.createElement("span");if(c.textContent=t,s.appendChild(c),n){let f=document.createElement("button");f.type="button",f.classList.add("nojs-toast-dismiss"),f.setAttribute("aria-label","Dismiss"),f.textContent="\xD7",f.addEventListener("click",()=>kt(s)),s.appendChild(f)}if(kr(d)&&e.firstChild?e.insertBefore(s,e.firstChild):e.appendChild(s),i>0){let f=setTimeout(()=>{pt.delete(f),kt(s)},i);pt.add(f),s._toastTimerId=f}return s}function kt(e){!e||!e.isConnected||(e._toastTimerId!=null&&(clearTimeout(e._toastTimerId),pt.delete(e._toastTimerId)),e.remove())}function je(e){we(),e.directive("toast-container",{priority:10,init(r,i,n){let o=n&&wr.has(n)?n:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",o),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),Z.set(o,r),e._onDispose(()=>{Z.get(o)===r&&Z.delete(o)})}}),e.directive("toast",{priority:10,init(r,i,n){if(!n)return;let o=r.getAttribute("toast-type")||"info",d=parseInt(r.getAttribute("toast-duration"),10)||3e3,s=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let p=()=>{let a=zt();Ft(a,n,o,d,s)};r.addEventListener("click",p),e._onDispose(()=>r.removeEventListener("click",p));return}let f=e.findContext(r),l;function u(){let p=e.evaluate(n,f);if(p&&p!==l){let a=typeof p=="string"?p:String(p),g=zt();Ft(g,a,o,d,s)}l=p}let h=f.$watch(u);e._onDispose(h)}});let t=(r,i="info",n=3e3)=>{if(typeof document>"u")return;let o=!0,d=zt();return Ft(d,String(r),i,n,o)};t.dismiss=r=>{let i=document.querySelector(`[data-toast-id="${r}"]`);i&&kt(i)},t.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>kt(r))},e.toast=t}function ke(e,t={}){je(e)}function _e(){Ae()}var et={containers:new Map};function Le(){et.containers.clear()}function Ce(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let e=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-table",""),t.textContent=e,document.head.appendChild(t)}function Br(e,t){let r=e.querySelector("tbody");if(!r)return null;let i=r.querySelector("[each]")||r.querySelector("[foreach]");if(!i)return null;let n=i.getAttribute("each")||i.getAttribute("foreach");if(!n)return null;let o=n.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return o?{iteratorVar:o[1],arrayPath:o[2].trim()}:null}function zr(e,t){let r=t.split("."),i=e;for(let n of r){if(i==null)return;i=i[n]}return i}function or(e,t,r){let i=t.split("."),n=e;for(let o=0;o<i.length-1;o++){if(n[i[o]]==null)return;n=n[i[o]]}n[i[i.length-1]]=r}function sr(e,t,r){if(e==null&&t==null)return 0;if(e==null)return-1;if(t==null)return 1;switch(r){case"number":return Number(e)-Number(t);case"date":return new Date(e).getTime()-new Date(t).getTime();default:return String(e).localeCompare(String(t))}}function Fr(e){let t=e.querySelectorAll("th[data-sortable]");for(let r of t)r.removeAttribute("data-sort-dir"),r.setAttribute("aria-sort","none")}function ar(e){e.directive("sortable",{priority:10,init(t){vt(),t.classList.add("nojs-sortable")}})}function dr(e){e.directive("sort",{priority:11,init(t,r,i){vt();let n=i;if(!n)return;let o=t.getAttribute("sort-type")||"string",d=t.getAttribute("sort-default");t.setAttribute("data-sortable",""),t.setAttribute("aria-sort","none");let s=t.closest("table");if(!s)return;ut.sorts.has(s)||ut.sorts.set(s,{column:null,direction:null}),(d==="asc"||d==="desc")&&ir(t,s,n,o,d,e);let c=()=>{let f=ut.sorts.get(s),l;f.column!==n?l="asc":f.direction==="asc"?l="desc":f.direction==="desc"?l=null:l="asc",ir(t,s,n,o,l,e)};t.addEventListener("click",c),e._onDispose(()=>{t.removeEventListener("click",c),s&&s._nojsOriginalOrder&&delete s._nojsOriginalOrder})}})}function ir(e,t,r,i,n,o){let d=ut.sorts.get(t);Fr(t),n?(e.setAttribute("data-sort-dir",n),e.setAttribute("aria-sort",n==="asc"?"ascending":"descending"),d.column=r,d.direction=n):(d.column=null,d.direction=null);let s=Br(t,o);if(s){let c=o.findContext(t),f=c?zr(c,s.arrayPath):null;if(Array.isArray(f)){if(!n){let u=t._nojsOriginalOrder;if(u){let h=new Set(f),p=u.filter(a=>h.has(a));for(let a of f)u.includes(a)||p.push(a);or(c,s.arrayPath,p)}return}t._nojsOriginalOrder||(t._nojsOriginalOrder=[...f]);let l=[...f].sort((u,h)=>{let p=u!=null?u[r]:null,a=h!=null?h[r]:null,g=sr(p,a,i);return n==="desc"?-g:g});or(c,s.arrayPath,l);return}}Mr(t,e,r,i,n)}function Mr(e,t,r,i,n){let o=e.querySelector("tbody");if(!o)return;let c=[...t.closest("tr").children].indexOf(t);if(c<0)return;let f=[...o.querySelectorAll(":scope > tr")];if(e._nojsOriginalRows||(e._nojsOriginalRows=[...f]),!n){let u=document.createDocumentFragment();for(let h of e._nojsOriginalRows)u.appendChild(h);o.appendChild(u);return}f.sort((u,h)=>{let p=u.children[c]?.textContent?.trim()||"",a=h.children[c]?.textContent?.trim()||"",g=sr(i==="number"?parseFloat(p.replace(/[^0-9.\-]/g,""))||0:p,i==="number"?parseFloat(a.replace(/[^0-9.\-]/g,""))||0:a,i);return n==="desc"?-g:g});let l=document.createDocumentFragment();for(let u of f)l.appendChild(u);o.appendChild(l)}function cr(e){e.directive("fixed-header",{priority:10,init(t){vt(),t.classList.add("nojs-fixed-header")}})}function lr(e){e.directive("fixed-col",{priority:10,init(t){vt(),t.classList.add("nojs-fixed-col")}})}function pr(e,t={}){ar(e),dr(e),cr(e),lr(e)}function ur(){nr()}var $r={name:"nojs-elements",install(e,t={}){Kt(e,t),Qt(e,t),ee(e,t),le(e,t),ve(e,t),ke(e,t),Be(e,t),Re(e,t),Ke(e,t),Ze(e,t),er(e,t),pr(e,t)},dispose(e){Yt(),Nt(),re(),pe(),ye(),_e(),ze(),Oe(),Ye(),rr(),ur()}},ji=$r;export{ji as default};
