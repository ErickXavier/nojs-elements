 ...
 * @license MIT
 */
(()=>{var m={dragging:null,selected:new Map,placeholder:null},Et=new Map;function qt(){m.dragging=null,m.selected.clear(),m.placeholder=null,Et.clear()}function it(){if(typeof document>"u"||document.querySelector("style[data-nojs-dnd]"))return;let e=`
.nojs-dragging {
  opacity: 0.5;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tooltip",""),t.textContent=e,document.head.appendChild(t)}var wt=8;function br(e,t,r){let i=t.getBoundingClientRect(),n=e.getBoundingClientRect(),o=window.innerWidth,d=window.innerHeight,s,c;switch(r){case"bottom":s=i.bottom+wt,c=i.left+(i.width-n.width)/2;break;case"left":s=i.top+(i.height-n.height)/2,c=i.left-n.width-wt;break;case"right":s=i.top+(i.height-n.height)/2,c=i.right+wt;break;default:s=i.top-n.height-wt,c=i.left+(i.width-n.width)/2;break}c<4&&(c=4),c+n.width>o-4&&(c=o-n.width-4),s<4&&(s=4),s+n.height>d-4&&(s=d-n.height-4),e.style.top=`${s}px`,e.style.left=`${c}px`}var hr=0;function vr(e,t,r){document.body.appendChild(t),br(t,e,r),t.setAttribute("aria-hidden","false")}function yr(e,t){t.setAttribute("aria-hidden","true"),t.remove()}function Zt(e){e.directive("tooltip",{priority:20,init(t,r,i){Xt();let n=i;if(!n){e._warn("[tooltip] attribute value (tooltip text) is required.");return}let o=t.getAttribute("tooltip-position")||"top",d=parseInt(t.getAttribute("tooltip-delay"),10)||300,s=t.getAttribute("tooltip-disabled"),c=s?e.findContext(t):null,f=`nojs-tooltip-${++hr}`,l=document.createElement("div");l.className="nojs-tooltip",l.setAttribute("role","tooltip"),l.setAttribute("id",f),l.setAttribute("aria-hidden","true"),l.textContent=n,t.setAttribute("aria-describedby",f),gt.set(t,l);let u=()=>{if(s&&c&&e.evaluate(s,c))return;K.has(t)&&clearTimeout(K.get(t));let y=setTimeout(()=>{K.delete(t),!(s&&c&&e.evaluate(s,c))&&vr(t,l,o)},d);K.set(t,y)},h=()=>{K.has(t)&&(clearTimeout(K.get(t)),K.delete(t)),yr(t,l)},p=()=>u(),a=()=>h(),g=()=>u(),b=()=>h(),v=y=>{y.key==="Escape"&&l.getAttribute("aria-hidden")==="false"&&h()};t.addEventListener("mouseenter",p),t.addEventListener("mouseleave",a),t.addEventListener("focusin",g),t.addEventListener("focusout",b),t.addEventListener("keydown",v),e._onDispose(()=>{t.removeEventListener("mouseenter",p),t.removeEventListener("mouseleave",a),t.removeEventListener("focusin",g),t.removeEventListener("focusout",b),t.removeEventListener("keydown",v),K.has(t)&&(clearTimeout(K.get(t)),K.delete(t)),l.remove(),gt.delete(t)})}})}function Qt(e,t={}){Zt(e)}function Nt(){Ut()}var P=new Map;function Jt(){P.clear()}function jt(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let e=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-modal",""),t.textContent=e,document.head.appendChild(t)}var se='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',Bt=new WeakMap;function Er(e){let t=r=>{if(r.key!=="Tab")return;let i=[...e.querySelectorAll(se)].filter(d=>d.offsetParent!==null);if(i.length===0){r.preventDefault();return}let n=i[0],o=i[i.length-1];r.shiftKey?document.activeElement===n&&(r.preventDefault(),o.focus()):document.activeElement===o&&(r.preventDefault(),n.focus())};e.addEventListener("keydown",t),Bt.set(e,t)}function ie(e){let t=Bt.get(e);t&&(e.removeEventListener("keydown",t),Bt.delete(e))}var mt=new WeakMap;function ae(e){e.directive("modal",{priority:10,init(r,i,n){dt();let o=n||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${o}`,r.setAttribute("data-modal-id",o),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let d=r.querySelector("h1, h2, h3, h4, h5, h6");d&&(d.id||(d.id=`nojs-modal-heading-${o}`),r.setAttribute("aria-labelledby",d.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let c=r.getAttribute("modal-class"),f=r.getAttribute("modal-escape"),l=h=>{h.target===r&&s!=="false"&&f!=="false"&&ct(r,o)};r.addEventListener("click",l),X.set(o,r);let u=h=>{if(h.newState==="open"){if(r.style.zIndex=String(ne()),c&&c.split(/\s+/).filter(Boolean).forEach(p=>r.classList.add(p)),requestAnimationFrame(()=>{let p=r.querySelector(se);p?p.focus():r.focus()}),Er(r),f!=="false"){let p=a=>{a.key==="Escape"&&(a.stopPropagation(),ct(r,o))};r.addEventListener("keydown",p),mt.set(r,p)}}else if(h.newState==="closed"){c&&c.split(/\s+/).filter(Boolean).forEach(g=>r.classList.remove(g)),ie(r);let p=mt.get(r);p&&(r.removeEventListener("keydown",p),mt.delete(r));let a=G.findIndex(g=>g.id===o);if(a!==-1){let g=G[a];G.splice(a,1),g.triggerEl&&requestAnimationFrame(()=>{g.triggerEl.focus()})}}};r.addEventListener("toggle",u),e._onDispose(()=>{r.removeEventListener("click",l),r.removeEventListener("toggle",u),ie(r);let h=mt.get(r);h&&(r.removeEventListener("keydown",h),mt.delete(r)),X.delete(o);let p=G.findIndex(a=>a.id===o);p!==-1&&G.splice(p,1)})}});let t=r=>t.open(r);t.open=r=>{let i=X.get(r);if(!i)return!1;G.push({id:r,el:i,triggerEl:null});try{i.showPopover()}catch{return!1}return!0},t.close=r=>{let i=X.get(r);return i?(ct(i,r),!0):!1},t.closeAll=()=>{for(let r=G.length-1;r>=0;r--)ct(G[r].el,G[r].id)},e.modal=t}function ct(e,t){try{e.hidePopover()}catch{}}function de(e){e.directive("modal-open",{priority:10,init(t,r,i){dt();let n=i;if(!n){let u=(t.closest("[use]")||t.parentElement)?.querySelector("[data-modal-id]");if(u&&(n=u.getAttribute("data-modal-id")),!n){e._warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}t.setAttribute("aria-haspopup","dialog"),t.setAttribute("aria-expanded","false");let o=()=>{let l=X.get(n)||document.querySelector(`[data-modal-id="${n}"]`);if(!l){e._warn(`[modal-open] modal "${n}" not found`);return}G.push({id:n,el:l,triggerEl:t}),t.setAttribute("aria-expanded","true"),l.id&&t.setAttribute("aria-controls",l.id);try{l.showPopover()}catch{e._warn(`[modal-open] failed to open modal "${n}"`)}},d=()=>{t.setAttribute("aria-expanded","false")},s=null,c=null;requestAnimationFrame(()=>{let l=X.get(n);l&&(c=l,s=u=>{u.newState==="closed"&&t.setAttribute("aria-expanded","false")},l.addEventListener("toggle",s))}),t.addEventListener("click",o),e._onDispose(()=>{t.removeEventListener("click",o),c&&s&&c.removeEventListener("toggle",s)})}})}function ce(e){e.directive("modal-close",{priority:10,init(t,r,i){dt();let n=()=>{let o,d;if(i){if(d=i,o=X.get(d),!o){e._warn(`[modal-close] modal "${d}" not found`);return}}else{if(o=t.closest("[modal]"),!o){e._warn("[modal-close] no parent modal found");return}d=o.getAttribute("modal")}ct(o,d)};t.addEventListener("click",n),e._onDispose(()=>{t.removeEventListener("click",n)})}})}function le(e,t={}){ae(e),de(e),ce(e)}function pe(){oe()}var bt={openMenus:new Map};function ue(){bt.openMenus.clear()}function lt(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let e=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-toast",""),t.textContent=e,document.head.appendChild(t)}var jr=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function zt(){return Z.size>0?Z.values().next().value:kr("top-right")}function kr(e){if(Z.has(e))return Z.get(e);let t=document.createElement("div");return t.classList.add("nojs-toast-container"),t.setAttribute("data-position",e),t.setAttribute("role","log"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-relevant","additions"),document.body.appendChild(t),Z.set(e,t),t}function _r(e){return e.startsWith("top")}function Ft(e,t,r,i,n){let o=Ee(),d=e.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",o),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let c=document.createElement("span");if(c.textContent=t,s.appendChild(c),n){let f=document.createElement("button");f.type="button",f.classList.add("nojs-toast-dismiss"),f.setAttribute("aria-label","Dismiss"),f.textContent="\xD7",f.addEventListener("click",()=>kt(s)),s.appendChild(f)}if(_r(d)&&e.firstChild?e.insertBefore(s,e.firstChild):e.appendChild(s),i>0){let f=setTimeout(()=>{pt.delete(f),kt(s)},i);pt.add(f),s._toastTimerId=f}return s}function kt(e){!e||!e.isConnected||(e._toastTimerId!=null&&(clearTimeout(e._toastTimerId),pt.delete(e._toastTimerId)),e.remove())}function je(e){we(),e.directive("toast-container",{priority:10,init(r,i,n){let o=n&&jr.has(n)?n:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",o),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),Z.set(o,r),e._onDispose(()=>{Z.get(o)===r&&Z.delete(o)})}}),e.directive("toast",{priority:10,init(r,i,n){if(!n)return;let o=r.getAttribute("toast-type")||"info",d=parseInt(r.getAttribute("toast-duration"),10)||3e3,s=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let p=()=>{let a=zt();Ft(a,n,o,d,s)};r.addEventListener("click",p),e._onDispose(()=>r.removeEventListener("click",p));return}let f=e.findContext(r),l;function u(){let p=e.evaluate(n,f);if(p&&p!==l){let a=typeof p=="string"?p:String(p),g=zt();Ft(g,a,o,d,s)}l=p}let h=f.$watch(u);e._onDispose(h)}});let t=(r,i="info",n=3e3)=>{if(typeof document>"u")return;let o=!0,d=zt();return Ft(d,String(r),i,n,o)};t.dismiss=r=>{let i=document.querySelector(`[data-toast-id="${r}"]`);i&&kt(i)},t.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>kt(r))},e.toast=t}function ke(e,t={}){je(e)}function _e(){Ae()}var et={containers:new Map};function Le(){et.containers.clear()}function Ce(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let e=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tree",""),t.textContent=e,document.head.appendChild(t)}function Me(e){let t=[],r=document.createTreeWalker(e,NodeFilter.SHOW_ELEMENT,{acceptNode(n){return n.matches&&n.matches('.nojs-subtree[aria-hidden="true"]')?NodeFilter.FILTER_REJECT:n.getAttribute("role")==="treeitem"?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}}),i;for(;i=r.nextNode();)t.push(i);return t}function $e(e){return e.closest('[role="tree"]')}function Cr(e){let t=e.cloneNode(!0);return t.querySelectorAll('[role="group"]').forEach(i=>i.remove()),(t.textContent||"").trim().toLowerCase()}function He(e){e.directive("tree",{priority:15,init(t){_t(),t.classList.add("nojs-tree"),t.setAttribute("role","tree"),t.getAttribute("tree-icon")==="false"&&t.setAttribute("data-tree-icon","false")}})}function Pe(e){e.directive("branch",{priority:16,init(t,r,i){_t();let n=i==="expanded";t.classList.add("nojs-branch"),t.setAttribute("role","treeitem"),t.setAttribute("aria-expanded",String(n));let o=$e(t);if(o){let p=o.querySelector('[role="treeitem"]');t.setAttribute("tabindex",p===t?"0":"-1")}else t.setAttribute("tabindex","0");let d=!1;queueMicrotask(()=>{if(d)return;let p=t.querySelector(":scope > [subtree], :scope > .nojs-subtree")||(t.nextElementSibling?.matches?.("[subtree], .nojs-subtree")?t.nextElementSibling:null);p?(I.branches.set(t,{expanded:n,subtreeEl:p}),p.setAttribute("aria-hidden",String(!n))):I.branches.set(t,{expanded:n,subtreeEl:null})});function s(p){let a=I.selectedItem;a&&a!==p&&(a.classList.remove("nojs-branch-selected"),a.setAttribute("aria-selected","false")),p.classList.add("nojs-branch-selected"),p.setAttribute("aria-selected","true"),I.selectedItem=p}function c(p){let a=I.branches.get(p);!a||!a.subtreeEl||(a.expanded=!a.expanded,p.setAttribute("aria-expanded",String(a.expanded)),a.subtreeEl.setAttribute("aria-hidden",String(!a.expanded)))}function f(p){let a=I.branches.get(p);!a||!a.subtreeEl||a.expanded||(a.expanded=!0,p.setAttribute("aria-expanded","true"),a.subtreeEl.setAttribute("aria-hidden","false"))}function l(p){let a=I.branches.get(p);!a||!a.subtreeEl||!a.expanded||(a.expanded=!1,p.setAttribute("aria-expanded","false"),a.subtreeEl.setAttribute("aria-hidden","true"))}let u=p=>{p.target!==t&&!t.contains(p.target)||(p.stopPropagation(),s(t),c(t))};t.addEventListener("click",u),e._onDispose(()=>t.removeEventListener("click",u));let h=p=>{let a=$e(t);if(!a)return;let g=Me(a),b=g.indexOf(t),v=I.branches.get(t),y=v&&v.subtreeEl;switch(p.key){case"ArrowRight":if(p.preventDefault(),y&&!v.expanded)f(t);else if(y&&v.expanded){let x=v.subtreeEl.querySelector('[role="treeitem"]');x&&rt(x,g)}break;case"ArrowLeft":if(p.preventDefault(),y&&v.expanded)l(t);else{let x=t.parentElement?.closest('[role="treeitem"]');x&&rt(x,Me(a))}break;case"ArrowDown":p.preventDefault(),b<g.length-1&&rt(g[b+1],g);break;case"ArrowUp":p.preventDefault(),b>0&&rt(g[b-1],g);break;case"Enter":case" ":p.preventDefault(),s(t),c(t);break;case"Home":p.preventDefault(),g.length>0&&rt(g[0],g);break;case"End":p.preventDefault(),g.length>0&&rt(g[g.length-1],g);break;default:if(p.key.length===1&&!p.ctrlKey&&!p.altKey&&!p.metaKey){p.preventDefault(),I.typeahead+=p.key.toLowerCase(),I.typeaheadTimer&&clearTimeout(I.typeaheadTimer),I.typeaheadTimer=setTimeout(()=>{I.typeahead="",I.typeaheadTimer=null},500);let x=b+1;for(let j=0;j<g.length;j++){let E=(x+j)%g.length;if(Cr(g[E]).startsWith(I.typeahead)){rt(g[E],g);break}}}break}};t.addEventListener("keydown",h),e._onDispose(()=>t.removeEventListener("keydown",h)),e._onDispose(()=>{d=!0,I.branches.delete(t),I.selectedItem===t&&(I.selectedItem=null)})}})}function rt(e,t){for(let r of t)r.setAttribute("tabindex",r===e?"0":"-1");e.focus()}function qe(e){e.directive("subtree",{priority:16,init(t){_t(),t.classList.add("nojs-subtree"),t.classList.add("nojs-tree"),t.setAttribute("role","group");for(let i of t.children)i.tagName==="LI"&&!i.querySelector("[branch], .nojs-branch")&&(i.setAttribute("role","treeitem"),i.setAttribute("tabindex","-1"),i.classList.add("nojs-tree-leaf"));let r=t.parentElement?.matches?.('[role="treeitem"]')?t.parentElement:t.previousElementSibling?.matches?.('[role="treeitem"]')?t.previousElementSibling:null;if(r){let i=I.branches.get(r);i?(t.setAttribute("aria-hidden",String(!i.expanded)),i.subtreeEl=t):t.setAttribute("aria-hidden","true")}else t.setAttribute("aria-hidden","true")}})}function Re(e,t={}){He(e),Pe(e),qe(e)}function Oe(){Fe()}var Lt=new Map;function Ge(){Lt.clear()}function Ct(){if(typeof document>"u"||document.querySelector("style[data-nojs-stepper]"))return;let e=`
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-split",""),t.textContent=e,document.head.appendChild(t)}function Ne(e){return e==="horizontal"?"clientX":"clientY"}function q(e,t){return t==="horizontal"?e.offsetWidth:e.offsetHeight}function Sr(e,t){let i=(nt.get(e)?.gutters||[]).reduce((n,o)=>n+q(o,t),0);return q(e,t)-i}function Tt(e,t){let r=$.get(t);return r?r.min!=null&&e<r.min?r.min:r.max!=null&&e>r.max?r.max:e:e}function St(e,t,r,i){let n=q(t,i),o=q(r,i),d=$.get(t),s=$.get(r);e.setAttribute("aria-valuenow",Math.round(n)),e.setAttribute("aria-valuemin",d?.min||0),e.setAttribute("aria-valuemax",Math.round(n+o-(s?.min||0)))}function $t(e){let t=e.getAttribute("split-persist");if(!t)return;let r=nt.get(e);if(!r)return;let i=r.panes.map(n=>n.style.flexBasis||"");try{localStorage.setItem(`nojs-split:${t}`,JSON.stringify(i))}catch{}}function Ir(e){let t=e.getAttribute("split-persist");if(!t)return!1;try{let r=localStorage.getItem(`nojs-split:${t}`);if(!r)return!1;let i=JSON.parse(r),n=nt.get(e);return!n||i.length!==n.panes.length?!1:(i.forEach((o,d)=>{o&&(n.panes[d].style.flexBasis=o,n.panes[d].style.flexGrow="0")}),!0)}catch{return!1}}function Br(e,t,r,i,n){let o=document.createElement("div");o.className="nojs-gutter",o.setAttribute("role","separator"),o.setAttribute("tabindex","0"),o.setAttribute("aria-orientation",t==="horizontal"?"vertical":"horizontal"),o.setAttribute("aria-label","Resize"),n!==6&&o.style.setProperty("--nojs-gutter-size",`${n}px`);let d=p=>{if(p.button!==0)return;p.preventDefault();let a=Sr(e,t);w.active=!0,w.splitEl=e,w.gutterEl=o,w.prevPane=r,w.nextPane=i,w.direction=t,w.startPos=p[Ne(t)],w.startPrevSize=q(r,t),w.startNextSize=q(i,t),w.containerSize=a,document.body.style.cursor=t==="horizontal"?"col-resize":"row-resize",document.body.style.userSelect="none",o.setPointerCapture(p.pointerId)},s=p=>{if(!w.active||w.gutterEl!==o)return;let a=p[Ne(w.direction)]-w.startPos,g=Tt(w.startPrevSize+a,w.prevPane),b=Tt(w.startNextSize-a,w.nextPane),v=w.startPrevSize+w.startNextSize;g+b!==v&&(g!==w.startPrevSize+a?b=v-g:g=v-b),w.prevPane.style.flexBasis=`${g}px`,w.prevPane.style.flexGrow="0",w.nextPane.style.flexBasis=`${b}px`,w.nextPane.style.flexGrow="0",St(o,w.prevPane,w.nextPane,w.direction)},c=()=>{!w.active||w.gutterEl!==o||(w.active=!1,document.body.style.cursor="",document.body.style.userSelect="",$t(e),e.dispatchEvent(new CustomEvent("split-resize",{bubbles:!0,detail:{prevPane:r,nextPane:i}})))};o.addEventListener("pointerdown",d),o.addEventListener("pointermove",s),o.addEventListener("pointerup",c),o.addEventListener("pointercancel",c);let f=10,l=p=>{let a=t==="horizontal",g=0;if(a&&p.key==="ArrowRight"||!a&&p.key==="ArrowDown")g=f;else if(a&&p.key==="ArrowLeft"||!a&&p.key==="ArrowUp")g=-f;else if(p.key==="Home")g=($.get(r)?.min||0)-q(r,t);else if(p.key==="End"){let E=$.get(i);g=q(r,t)+q(i,t)-(E?.min||0)-q(r,t)}else return;p.preventDefault();let b=q(r,t),v=q(i,t),y=b+v,x=Tt(b+g,r),j=Tt(y-x,i);x=y-j,r.style.flexBasis=`${x}px`,r.style.flexGrow="0",i.style.flexBasis=`${j}px`,i.style.flexGrow="0",St(o,r,i,t),$t(e)};o.addEventListener("keydown",l);let u=()=>{let p=$.get(r),a=$.get(i),g=p?.collapsible?r:a?.collapsible?i:null;if(!g)return;let b=$.get(g);if(!b)return;let v=g===r?i:r,y=q(r,t)+q(i,t);if(b.collapsed){b.collapsed=!1,g.removeAttribute("data-collapsed");let x=b.preCollapseSize||`${Math.round(y/2)}px`;g.style.flexBasis=x,g.style.flexGrow="0",v.style.flexBasis=`${y-parseFloat(x)}px`,v.style.flexGrow="0"}else b.preCollapseSize=g.style.flexBasis||`${q(g,t)}px`,b.collapsed=!0,g.setAttribute("data-collapsed","true"),g.style.flexBasis="0px",g.style.flexGrow="0",v.style.flexBasis=`${y}px`,v.style.flexGrow="0";St(o,r,i,t),$t(e),e.dispatchEvent(new CustomEvent("split-collapse",{bubbles:!0,detail:{pane:g,collapsed:b.collapsed}}))};return o.addEventListener("dblclick",u),{gutter:o,cleanup:()=>{o.removeEventListener("pointerdown",d),o.removeEventListener("pointermove",s),o.removeEventListener("pointerup",c),o.removeEventListener("pointercancel",c),o.removeEventListener("keydown",l),o.removeEventListener("dblclick",u)}}}function Je(e){e.directive("split",{priority:14,init(t,r,i){Dt();let n=(i||"horizontal").trim()==="vertical"?"vertical":"horizontal",o=parseInt(t.getAttribute("split-gutter"),10)||6;t.classList.add("nojs-split"),t.setAttribute("data-direction",n);let d=Array.from(t.children).filter(l=>l.hasAttribute("pane"));if(d.length<2){e._warn(`[split] Container requires at least 2 [pane] children, found ${d.length}.`);return}d.forEach(l=>{$.get(l)||$.set(l,{size:l.getAttribute("pane")||null,min:parseInt(l.getAttribute("pane-min"),10)||0,max:parseInt(l.getAttribute("pane-max"),10)||1/0,collapsible:l.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null})});let s=[],c=[];for(let l=0;l<d.length-1;l++){let{gutter:u,cleanup:h}=Br(t,n,d[l],d[l+1],o);d[l].after(u),s.push(u),c.push(h)}nt.set(t,{direction:n,gutterSize:o,panes:d,gutters:s}),Ir(t)||d.forEach(l=>{let h=$.get(l)?.size;h?(l.style.flexBasis=h,l.style.flexGrow="0"):(l.style.flexGrow="1",l.style.flexBasis="0")}),requestAnimationFrame(()=>{s.forEach((l,u)=>{St(l,d[u],d[u+1],n)})}),e._onDispose(()=>{c.forEach(l=>l()),s.forEach(l=>l.remove()),nt.delete(t),d.forEach(l=>$.delete(l)),t.classList.remove("nojs-split"),t.removeAttribute("data-direction")})}})}function tr(e){e.directive("pane",{priority:15,init(t,r,i){Dt(),t.classList.add("nojs-pane"),$.has(t)||$.set(t,{size:i||null,min:parseInt(t.getAttribute("pane-min"),10)||0,max:parseInt(t.getAttribute("pane-max"),10)||1/0,collapsible:t.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null});let n=$.get(t),o=t.closest("[data-direction='vertical']")?"height":"width";n.min&&(t.style[`min${o==="width"?"Width":"Height"}`]=`${n.min}px`),n.max&&n.max!==1/0&&(t.style[`max${o==="width"?"Width":"Height"}`]=`${n.max}px`),e._onDispose(()=>{t.classList.remove("nojs-pane"),$.delete(t),t.style.removeProperty("minWidth"),t.style.removeProperty("minHeight"),t.style.removeProperty("maxWidth"),t.style.removeProperty("maxHeight"),t.style.removeProperty("flexBasis"),t.style.removeProperty("flexGrow")})}})}function er(e,t={}){Je(e),tr(e)}function rr(){Qe()}var ut={sorts:new Map};function nr(){ut.sorts.clear()}function vt(){if(typeof document>"u"||document.querySelector("style[data-nojs-table]"))return;let e=`
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-table",""),t.textContent=e,document.head.appendChild(t)}function zr(e,t){let r=e.querySelector("tbody");if(!r)return null;let i=r.querySelector("[each]")||r.querySelector("[foreach]");if(!i)return null;let n=i.getAttribute("each")||i.getAttribute("foreach");if(!n)return null;let o=n.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return o?{iteratorVar:o[1],arrayPath:o[2].trim()}:null}function Fr(e,t){let r=t.split("."),i=e;for(let n of r){if(i==null)return;i=i[n]}return i}function or(e,t,r){let i=t.split("."),n=e;for(let o=0;o<i.length-1;o++){if(n[i[o]]==null)return;n=n[i[o]]}n[i[i.length-1]]=r}function sr(e,t,r){if(e==null&&t==null)return 0;if(e==null)return-1;if(t==null)return 1;switch(r){case"number":return Number(e)-Number(t);case"date":return new Date(e).getTime()-new Date(t).getTime();default:return String(e).localeCompare(String(t))}}function Mr(e){let t=e.querySelectorAll("th[data-sortable]");for(let r of t)r.removeAttribute("data-sort-dir"),r.setAttribute("aria-sort","none")}function ar(e){e.directive("sortable",{priority:10,init(t){vt(),t.classList.add("nojs-sortable")}})}function dr(e){e.directive("sort",{priority:11,init(t,r,i){vt();let n=i;if(!n)return;let o=t.getAttribute("sort-type")||"string",d=t.getAttribute("sort-default");t.setAttribute("data-sortable",""),t.setAttribute("aria-sort","none");let s=t.closest("table");if(!s)return;ut.sorts.has(s)||ut.sorts.set(s,{column:null,direction:null}),(d==="asc"||d==="desc")&&ir(t,s,n,o,d,e);let c=()=>{let f=ut.sorts.get(s),l;f.column!==n?l="asc":f.direction==="asc"?l="desc":f.direction==="desc"?l=null:l="asc",ir(t,s,n,o,l,e)};t.addEventListener("click",c),e._onDispose(()=>{t.removeEventListener("click",c),s&&s._nojsOriginalOrder&&delete s._nojsOriginalOrder})}})}function ir(e,t,r,i,n,o){let d=ut.sorts.get(t);Mr(t),n?(e.setAttribute("data-sort-dir",n),e.setAttribute("aria-sort",n==="asc"?"ascending":"descending"),d.column=r,d.direction=n):(d.column=null,d.direction=null);let s=zr(t,o);if(s){let c=o.findContext(t),f=c?Fr(c,s.arrayPath):null;if(Array.isArray(f)){if(!n){let u=t._nojsOriginalOrder;if(u){let h=new Set(f),p=u.filter(a=>h.has(a));for(let a of f)u.includes(a)||p.push(a);or(c,s.arrayPath,p)}return}t._nojsOriginalOrder||(t._nojsOriginalOrder=[...f]);let l=[...f].sort((u,h)=>{let p=u!=null?u[r]:null,a=h!=null?h[r]:null,g=sr(p,a,i);return n==="desc"?-g:g});or(c,s.arrayPath,l);return}}$r(t,e,r,i,n)}function $r(e,t,r,i,n){let o=e.querySelector("tbody");if(!o)return;let c=[...t.closest("tr").children].indexOf(t);if(c<0)return;let f=[...o.querySelectorAll(":scope > tr")];if(e._nojsOriginalRows||(e._nojsOriginalRows=[...f]),!n){let u=document.createDocumentFragment();for(let h of e._nojsOriginalRows)u.appendChild(h);o.appendChild(u);return}f.sort((u,h)=>{let p=u.children[c]?.textContent?.trim()||"",a=h.children[c]?.textContent?.trim()||"",g=sr(i==="number"?parseFloat(p.replace(/[^0-9.\-]/g,""))||0:p,i==="number"?parseFloat(a.replace(/[^0-9.\-]/g,""))||0:a,i);return n==="desc"?-g:g});let l=document.createDocumentFragment();for(let u of f)l.appendChild(u);o.appendChild(l)}function cr(e){e.directive("fixed-header",{priority:10,init(t){vt(),t.classList.add("nojs-fixed-header")}})}function lr(e){e.directive("fixed-col",{priority:10,init(t){vt(),t.classList.add("nojs-fixed-col")}})}function pr(e,t={}){ar(e),dr(e),cr(e),lr(e)}function ur(){nr()}var Hr={name:"nojs-elements",install(e,t={}){Kt(e,t),Qt(e,t),ee(e,t),le(e,t),ve(e,t),ke(e,t),Be(e,t),Re(e,t),Ke(e,t),Ze(e,t),er(e,t),pr(e,t)},dispose(e){Yt(),Nt(),re(),pe(),ye(),_e(),ze(),Oe(),Ye(),rr(),ur()}},fr=Hr;typeof window<"u"&&(window.NojsElements=fr);})();
