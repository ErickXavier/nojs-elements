...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tooltip",""),e.textContent=t,document.head.appendChild(e)}function Sn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var He=8;function Mt(t,e,r){let o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),i=window.innerWidth,d=window.innerHeight,s,a;switch(r){case"bottom":s=o.bottom+He,a=o.left+(o.width-n.width)/2;break;case"left":s=o.top+(o.height-n.height)/2,a=o.left-n.width-He;break;case"right":s=o.top+(o.height-n.height)/2,a=o.right+He;break;default:s=o.top-n.height-He,a=o.left+(o.width-n.width)/2;break}a<4&&(a=4),a+n.width>i-4&&(a=i-n.width-4),s<4&&(s=4),s+n.height>d-4&&(s=d-n.height-4),t.style.top=`${s}px`,t.style.left=`${a}px`}var Tn=0;function Dn(t,e,r){document.body.appendChild(e),Mt(e,t,r),e.setAttribute("aria-hidden","false")}function Rt(t,e){e.setAttribute("aria-hidden","true"),e.remove()}function In(t,e){t&&typeof t._warn=="function"?t._warn(e):console.warn(e)}function qt(t){t.directive("tooltip",{priority:20,init(e,r,o){$t();let n=o;if(!n){In(t,"[tooltip] attribute value (tooltip text) is required.");return}let i=e.getAttribute("tooltip-position")||"top",d=parseInt(e.getAttribute("tooltip-delay"),10),s=Number.isNaN(d)?300:d,a=e.getAttribute("tooltip-disabled"),c=a?t.findContext(e):null,f=()=>{if(!a||!c)return!1;try{return!!t.evaluate(a,c)}catch{return!1}},l=`nojs-tooltip-${++Tn}`,m=document.createElement("div");m.className="nojs-tooltip",m.setAttribute("role","tooltip"),m.setAttribute("id",l),m.setAttribute("aria-hidden","true"),m.textContent=n,e.setAttribute("aria-describedby",l),ve.set(e,m);let p=!1,g=0,v=()=>{!p||!e.isConnected||g||(g=requestAnimationFrame(()=>{g=0,!(!p||!e.isConnected)&&Mt(m,e,i)}))},y=()=>{window.addEventListener("scroll",v,!0),window.addEventListener("resize",v)},u=()=>{window.removeEventListener("scroll",v,!0),window.removeEventListener("resize",v),g&&(cancelAnimationFrame(g),g=0)},b=()=>{p||(Dn(e,m,i),p=!0,y())},A=()=>{if(!p){Rt(e,m);return}u(),Rt(e,m),p=!1},h=()=>{if(f())return;te.has(e)&&clearTimeout(te.get(e));let I=setTimeout(()=>{te.delete(e),!f()&&e.isConnected&&b()},s);te.set(e,I)},x=()=>{te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),A()},_=()=>h(),k=()=>x(),j=()=>h(),L=()=>x(),S=I=>{I.key==="Escape"&&m.getAttribute("aria-hidden")==="false"&&x()};e.addEventListener("mouseenter",_),e.addEventListener("mouseleave",k),e.addEventListener("focusin",j),e.addEventListener("focusout",L),e.addEventListener("keydown",S);let w=null;if(a&&c&&typeof c.$watch=="function"){let I=()=>{p&&f()&&A()};w=c.$watch(I)}Sn(e,()=>{e.removeEventListener("mouseenter",_),e.removeEventListener("mouseleave",k),e.removeEventListener("focusin",j),e.removeEventListener("focusout",L),e.removeEventListener("keydown",S),w&&(w(),w=null),u(),te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),p=!1,m.remove(),ve.delete(e)})}})}function zt(t,e={}){qt(t)}function Ht(){Ft()}var K=new Map;function Ot(){K.clear()}function Oe(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let t=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-modal",""),e.textContent=t,document.head.appendChild(e)}function Pn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Xt='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',rt=new WeakMap;function Fn(t){let e=r=>{if(r.key!=="Tab")return;let o=[...t.querySelectorAll(Xt)].filter(d=>d.offsetParent!==null);if(o.length===0){r.preventDefault();return}let n=o[0],i=o[o.length-1];r.shiftKey?document.activeElement===n&&(r.preventDefault(),i.focus()):document.activeElement===i&&(r.preventDefault(),n.focus())};t.addEventListener("keydown",e),rt.set(t,e)}function Kt(t){let e=rt.get(t);e&&(t.removeEventListener("keydown",e),rt.delete(t))}var Le=new WeakMap;function Nt(t){t.directive("modal",{priority:10,init(r,o,n){xe();let i=n||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${i}`,r.setAttribute("data-modal-id",i),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let d=r.querySelector("h1, h2, h3, h4, h5, h6");d&&(d.id||(d.id=`nojs-modal-heading-${i}`),r.setAttribute("aria-labelledby",d.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let a=r.getAttribute("modal-class"),c=r.getAttribute("modal-escape"),f=m=>{m.target===r&&s!=="false"&&c!=="false"&&Ee(r,i)};r.addEventListener("click",f),oe.set(i,r);let l=m=>{if(m.newState==="open"){if(r.style.zIndex=String(Ut()),a&&a.split(/\s+/).filter(Boolean).forEach(p=>r.classList.add(p)),requestAnimationFrame(()=>{if(!r.isConnected||!W.some(g=>g.el===r))return;let p=r.querySelector(Xt);p?p.focus():r.focus()}),Fn(r),c!=="false"){let p=g=>{g.key==="Escape"&&(g.stopPropagation(),Ee(r,i))};r.addEventListener("keydown",p),Le.set(r,p)}}else if(m.newState==="closed"){a&&a.split(/\s+/).filter(Boolean).forEach(v=>r.classList.remove(v)),Kt(r);let p=Le.get(r);p&&(r.removeEventListener("keydown",p),Le.delete(r));let g=W.findIndex(v=>v.el===r);if(g===-1&&(g=W.findIndex(v=>v.id===i)),g!==-1){let v=W[g];W.splice(g,1),v.triggerEl&&requestAnimationFrame(()=>{v.triggerEl.focus()})}}};r.addEventListener("toggle",l),Pn(r,()=>{r.removeEventListener("click",f),r.removeEventListener("toggle",l),Kt(r);let m=Le.get(r);m&&(r.removeEventListener("keydown",m),Le.delete(r)),oe.delete(i);let p=W.findIndex(g=>g.el===r);p===-1&&(p=W.findIndex(g=>g.id===i)),p!==-1&&W.splice(p,1)})}});let e=r=>e.open(r);e.open=r=>{let o=oe.get(r);if(!o)return!1;try{o.showPopover()}catch{return!1}return W.some(n=>n.id===r)||W.push({id:r,el:o,triggerEl:null}),!0},e.close=r=>{let o=oe.get(r);return o?(Ee(o,r),!0):!1},e.closeAll=()=>{for(let r=W.length-1;r>=0;r--)Ee(W[r].el,W[r].id)},t.modal=e}function Ee(t,e){try{t.hidePopover()}catch{}}function $n(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Rn(t){let e=document.querySelectorAll("[data-modal-id]");for(let r of e)if(r.getAttribute("data-modal-id")===t)return r;return null}function Zt(t){t.directive("modal-open",{priority:10,init(e,r,o){xe();let n=o;if(!n){let l=(e.closest("[use]")||e.parentElement)?.querySelector("[data-modal-id]");if(l&&(n=l.getAttribute("data-modal-id")),!n){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}e.setAttribute("aria-haspopup","dialog"),e.setAttribute("aria-expanded","false");let i=()=>{let f=oe.get(n)||Rn(n);if(!f){console.warn(`[modal-open] modal "${n}" not found`);return}let l=W.some(m=>m.id===n);f.id&&e.setAttribute("aria-controls",f.id);try{f.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${n}"`);return}l||W.push({id:n,el:f,triggerEl:e}),e.setAttribute("aria-expanded","true")},d=()=>{e.setAttribute("aria-expanded","false")},s=null,a=null,c=()=>{let f=oe.get(n);return f?(a=f,s=l=>{l.newState==="closed"&&e.setAttribute("aria-expanded","false")},f.addEventListener("toggle",s),!0):!1};c()||requestAnimationFrame(c),e.addEventListener("click",i),$n(e,()=>{e.removeEventListener("click",i),a&&s&&a.removeEventListener("toggle",s)})}})}function Mn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Qt(t){t.directive("modal-close",{priority:10,init(e,r,o){xe();let n=()=>{let i,d;if(o){if(d=o,i=oe.get(d),!i){console.warn(`[modal-close] modal "${d}" not found`);return}}else{if(i=e.closest("[modal]"),!i){console.warn("[modal-close] no parent modal found");return}d=i.getAttribute("modal")}Ee(i,d)};e.addEventListener("click",n),Mn(e,()=>{e.removeEventListener("click",n)})}})}function Jt(t,e={}){Nt(t),Zt(t),Qt(t)}function er(){Yt()}var ce={openMenus:new Map};function tr(){ce.openMenus.clear()}function we(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let t=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
