...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-modal",""),t.textContent=e,document.head.appendChild(t)}function Ne(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var zt='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',lt=new WeakMap;function Ye(e){let t=r=>{if(r.key!=="Tab")return;let i=[...e.querySelectorAll(zt)].filter(d=>d.offsetParent!==null);if(i.length===0){r.preventDefault();return}let o=i[0],n=i[i.length-1];r.shiftKey?document.activeElement===o&&(r.preventDefault(),n.focus()):document.activeElement===n&&(r.preventDefault(),o.focus())};e.addEventListener("keydown",t),lt.set(e,t)}function It(e){let t=lt.get(e);t&&(e.removeEventListener("keydown",t),lt.delete(e))}var N=new WeakMap;function Ft(e){e.directive("modal",{priority:10,init(r,i,o){$();let n=o||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${n}`,r.setAttribute("data-modal-id",n),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let d=r.querySelector("h1, h2, h3, h4, h5, h6");d&&(d.id||(d.id=`nojs-modal-heading-${n}`),r.setAttribute("aria-labelledby",d.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let l=r.getAttribute("modal-class"),f=r.getAttribute("modal-escape"),p=h=>{h.target===r&&s!=="false"&&f!=="false"&&R(r,n)};r.addEventListener("click",p),D.set(n,r);let m=h=>{if(h.newState==="open"){if(r.style.zIndex=String(Tt()),l&&l.split(/\s+/).filter(Boolean).forEach(c=>r.classList.add(c)),requestAnimationFrame(()=>{let c=r.querySelector(zt);c?c.focus():r.focus()}),Ye(r),f!=="false"){let c=a=>{a.key==="Escape"&&(a.stopPropagation(),R(r,n))};r.addEventListener("keydown",c),N.set(r,c)}}else if(h.newState==="closed"){l&&l.split(/\s+/).filter(Boolean).forEach(u=>r.classList.remove(u)),It(r);let c=N.get(r);c&&(r.removeEventListener("keydown",c),N.delete(r));let a=L.findIndex(u=>u.id===n);if(a!==-1){let u=L[a];L.splice(a,1),u.triggerEl&&requestAnimationFrame(()=>{u.triggerEl.focus()})}}};r.addEventListener("toggle",m),Ne(r,()=>{r.removeEventListener("click",p),r.removeEventListener("toggle",m),It(r);let h=N.get(r);h&&(r.removeEventListener("keydown",h),N.delete(r)),D.delete(n);let c=L.findIndex(a=>a.id===n);c!==-1&&L.splice(c,1)})}});let t=r=>t.open(r);t.open=r=>{let i=D.get(r);if(!i)return!1;L.push({id:r,el:i,triggerEl:null});try{i.showPopover()}catch{return!1}return!0},t.close=r=>{let i=D.get(r);return i?(R(i,r),!0):!1},t.closeAll=()=>{for(let r=L.length-1;r>=0;r--)R(L[r].el,L[r].id)},e.modal=t}function R(e,t){try{e.hidePopover()}catch{}}function Xe(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Pt(e){e.directive("modal-open",{priority:10,init(t,r,i){$();let o=i;if(!o){let m=(t.closest("[use]")||t.parentElement)?.querySelector("[data-modal-id]");if(m&&(o=m.getAttribute("data-modal-id")),!o){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}t.setAttribute("aria-haspopup","dialog"),t.setAttribute("aria-expanded","false");let n=()=>{let p=D.get(o)||document.querySelector(`[data-modal-id="${o}"]`);if(!p){console.warn(`[modal-open] modal "${o}" not found`);return}L.push({id:o,el:p,triggerEl:t}),t.setAttribute("aria-expanded","true"),p.id&&t.setAttribute("aria-controls",p.id);try{p.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${o}"`)}},d=()=>{t.setAttribute("aria-expanded","false")},s=null,l=null;requestAnimationFrame(()=>{let p=D.get(o);p&&(l=p,s=m=>{m.newState==="closed"&&t.setAttribute("aria-expanded","false")},p.addEventListener("toggle",s))}),t.addEventListener("click",n),Xe(t,()=>{t.removeEventListener("click",n),l&&s&&l.removeEventListener("toggle",s)})}})}function Ze(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Mt(e){e.directive("modal-close",{priority:10,init(t,r,i){$();let o=()=>{let n,d;if(i){if(d=i,n=D.get(d),!n){console.warn(`[modal-close] modal "${d}" not found`);return}}else{if(n=t.closest("[modal]"),!n){console.warn("[modal-close] no parent modal found");return}d=n.getAttribute("modal")}R(n,d)};t.addEventListener("click",o),Ze(t,()=>{t.removeEventListener("click",o)})}})}function qt(e,t={}){Ft(e),Pt(e),Mt(e)}function Bt(){Dt()}var P={openMenus:new Map};function Ht(){P.openMenus.clear()}function O(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let e=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-toast",""),t.textContent=e,document.head.appendChild(t)}function mt(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var er=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function bt(){return I.size>0?I.values().next().value:rr("top-right")}function rr(e){if(I.has(e))return I.get(e);let t=document.createElement("div");return t.classList.add("nojs-toast-container"),t.setAttribute("data-position",e),t.setAttribute("role","log"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-relevant","additions"),document.body.appendChild(t),I.set(e,t),t}function or(e){return e.startsWith("top")}function gt(e,t,r,i,o){let n=Nt(),d=e.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",n),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let l=document.createElement("span");if(l.textContent=t,s.appendChild(l),o){let f=document.createElement("button");f.type="button",f.classList.add("nojs-toast-dismiss"),f.setAttribute("aria-label","Dismiss"),f.textContent="\xD7",f.addEventListener("click",()=>J(s)),s.appendChild(f)}if(or(d)&&e.firstChild?e.insertBefore(s,e.firstChild):e.appendChild(s),i>0){let f=setTimeout(()=>{G.delete(f),J(s)},i);G.add(f),s._toastTimerId=f}return s}function J(e){!e||!e.isConnected||(e._toastTimerId!=null&&(clearTimeout(e._toastTimerId),G.delete(e._toastTimerId)),e.remove())}function Zt(e){Xt(),e.directive("toast-container",{priority:10,init(r,i,o){let n=o&&er.has(o)?o:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",n),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),I.set(n,r),mt(r,()=>{I.get(n)===r&&I.delete(n)})}}),e.directive("toast",{priority:10,init(r,i,o){if(!o)return;let n=r.getAttribute("toast-type")||"info",d=parseInt(r.getAttribute("toast-duration"),10)||3e3,s=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let c=()=>{let a=bt();gt(a,o,n,d,s)};r.addEventListener("click",c),mt(r,()=>r.removeEventListener("click",c));return}let f=e.findContext(r),p;function m(){let c=e.evaluate(o,f);if(c&&c!==p){let a=typeof c=="string"?c:String(c),u=bt();gt(u,a,n,d,s)}p=c}let h=f.$watch(m);mt(r,h)}});let t=(r,i="info",o=3e3)=>{if(typeof document>"u")return;let n=!0,d=bt();return gt(d,String(r),i,o,n)};t.dismiss=r=>{let i=document.querySelector(`[data-toast-id="${r}"]`);i&&J(i)},t.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>J(r))},e.toast=t}function Qt(e,t={}){Zt(e)}function Jt(){Yt()}var M={containers:new Map};function te(){M.containers.clear()}function ee(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let e=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tabs",""),t.textContent=e,document.head.appendChild(t)}function nr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var ir=0;function re(e){return`${e}-${++ir}`}function ht(e,t){let r=M.containers.get(e);if(!r)return;let{tabs:i,panels:o}=r;if(!(t<0||t>=i.length)&&i[t].getAttribute("aria-disabled")!=="true"){for(let n=0;n<i.length;n++)i[n].setAttribute("aria-selected","false"),i[n].setAttribute("tabindex","-1"),o[n].setAttribute("aria-hidden","true"),o[n].inert=!0;i[t].setAttribute("aria-selected","true"),i[t].setAttribute("tabindex","0"),o[t].setAttribute("aria-hidden","false"),o[t].inert=!1,r.activeIndex=t}}function Y(e,t,r){let i=e.length,o=t;for(let n=0;n<i;n++)if(o=(o+r+i)%i,e[o].getAttribute("aria-disabled")!=="true")return o;return t}function oe(e){e.directive("tabs",{priority:10,init(t,r,i){ee();let o=[],n=[];for(let a of Array.from(t.children))a.hasAttribute("tab")?o.push(a):a.hasAttribute("panel")&&n.push(a);if(o.length===0){console.warn("[tabs] No child [tab] elements found.");return}o.length!==n.length&&console.warn("[tabs] Mismatch: "+o.length+" tabs but "+n.length+" panels.");let d=t.getAttribute("tab-position")||"top";t.setAttribute("data-position",d),t.classList.add("nojs-tabs");let s=document.createElement("div");s.setAttribute("role","tablist"),s.classList.add("nojs-tablist");let l=Math.min(o.length,n.length);for(let a=0;a<l;a++){let u=o[a],b=n[a],g=u.id||re("nojs-tab"),y=b.id||re("nojs-panel");u.id=g,b.id=y,u.setAttribute("role","tab"),u.setAttribute("aria-selected","false"),u.setAttribute("aria-controls",y),u.setAttribute("tabindex","-1"),u.classList.add("nojs-tab"),b.setAttribute("role","tabpanel"),b.setAttribute("aria-labelledby",g),b.setAttribute("tabindex","0"),b.setAttribute("aria-hidden","true"),b.inert=!0,b.classList.add("nojs-panel"),s.appendChild(u)}let f=n[0];f?t.insertBefore(s,f):t.appendChild(s),M.containers.set(t,{tabs:o.slice(0,l),panels:n.slice(0,l),activeIndex:-1});let p=e.findContext(t);for(let a=0;a<l;a++){let u=o[a].getAttribute("tab-disabled");u&&e.evaluate(u,p)&&o[a].setAttribute("aria-disabled","true")}let m=0;if(i&&i.trim()!==""){let a=parseInt(i,10);!isNaN(a)&&a>=0&&a<l&&(m=a)}o[m]?.getAttribute("aria-disabled")==="true"&&(m=Y(o.slice(0,l),m,1)),ht(t,m);let h=a=>{let u=M.containers.get(t);if(!u)return;let b=a.target;if(b.getAttribute("role")!=="tab")return;let{tabs:g}=u,y=g.indexOf(b);if(y===-1)return;let w=-1;switch(a.key){case"ArrowRight":case"ArrowDown":w=Y(g,y,1);break;case"ArrowLeft":case"ArrowUp":w=Y(g,y,-1);break;case"Home":w=Y(g,g.length-1,1);break;case"End":w=Y(g,0,-1);break;case"Tab":return;default:return}w!==-1&&w!==y&&(a.preventDefault(),ht(t,w),g[w].focus())};s.addEventListener("keydown",h);let c=a=>{let u=a.target.closest("[role='tab']");if(!u)return;let b=M.containers.get(t);if(!b)return;let g=b.tabs.indexOf(u);g!==-1&&(ht(t,g),u.focus())};s.addEventListener("click",c),nr(t,()=>{s.removeEventListener("keydown",h),s.removeEventListener("click",c),M.containers.delete(t)})}})}function ne(e){e.directive("tab",{priority:11,init(){}}),e.directive("tab-disabled",{priority:11,init(){}}),e.directive("tab-position",{priority:11,init(){}})}function ie(e){e.directive("panel",{priority:11,init(){}})}function se(e,t={}){oe(e),ne(e),ie(e)}function ae(){te()}var E={branches:new Map,selectedItem:null,typeahead:"",typeaheadTimer:null};function ce(){E.branches.clear(),E.selectedItem=null,E.typeahead="",E.typeaheadTimer&&(clearTimeout(E.typeaheadTimer),E.typeaheadTimer=null)}function tt(){if(typeof document>"u"||document.querySelector("style[data-nojs-tree]"))return;let e=`
.nojs-tree {
  list-style: none;
  padding-left: 0;
  margin: 0;
